          ...
          DecimalFormat df2 = new DecimalFormat("###,###,###,###,###,###,###"); 
            ...
            try {
                ...
                ResultSet rs = stat.executeQuery("SELECT databarang.nama_brng,sum(detailbeli.jumlah),sum(detailbeli.subtotal) from pembelian inner join detailbeli inner join databarang"+
                        " on pembelian.no_faktur=detailbeli.no_faktur and detailbeli.kode_brng=databarang.kode_brng where "+symbol+" group by databarang.nama_brng order by sum(detailbeli.jumlah) desc limit 10");
                while (rs.next()) {
