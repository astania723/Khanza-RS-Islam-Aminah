...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"ID User","Nama User","Jabatan","Password","[J]ICD 10","[J]Obat Penyakit","[C]Dokter","[A]Jadwal Praktek","[C]Petugas","[M]Pasien","[A]Registrasi","[A]Tindakan Ralan",
                ...
                "[L]Pencarian SEP Apotek BPJS","[L]Monitoring Klaim Apotek BPJS","[L]Daftar Pelayanan Obat Apotek BPJS","[M]Penilaian Awal Medis Ralan Paru","[M]Catatan Keperawatan Ralan","[M]Pemantauan PEWS Pasien Maternal","[M]Validasi SBAR"
        };
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(540, 12, 60, 23);
        ...
        TNmUser.setBounds(275, 12, 260, 23);
        ...
        if(TKd.getText().trim().isEmpty()||TNmUser.getText().trim().isEmpty()){
            ...
            if(i!= -1){
                if(Sequel.mengedittf("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "pemantauan_pews_maternal='"+tbUser.getValueAt(i, 994).toString()+"',"+
                    "validasi_sbar='"+tbUser.getValueAt(i, 995).toString()+"'")==true){
                    emptTeks();
                }
            }         
        }
                            ...
                            try {
                                ...
                                if(i!= -1){
                                    Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                                        ...
                                        "pemantauan_pews_maternal='"+tbUser.getValueAt(barisdicopy, 994).toString()+"',"+
                                        "validasi_sbar='"+tbUser.getValueAt(barisdicopy, 995).toString()+"'");
                                }
                                userdicopy="";
                                copyhakakses="";
                                barisdicopy=-1;
