...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"ID User","Nama User","Jabatan","Password","[J]ICD 10","[J]Obat Penyakit","[C]Dokter","[A]Jadwal Praktek","[C]Petugas","[M]Pasien","[A]Registrasi","[A]Tindakan Ralan",
                ...
                "[L]Kirim Observation Radiologi Satu Sehat","[L]Kirim Diagnostic Report Radiologi Satu Sehat","[M]Hasil Endoskopi Telinga","[M]Pemantauan PEWS Pasien Maternal","[M]Validasi SBAR"
        };
        ...
        if(TKd.getText().trim().isEmpty()||TNmUser.getText().trim().isEmpty()){
            ...
            if(i!= -1){
                if(Sequel.mengedittf("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "pemantauan_pews_maternal='"+tbUser.getValueAt(i, 1022).toString()+"',"+
                    "validasi_sbar='"+tbUser.getValueAt(i, 1023).toString()+"'")==true){
                    emptTeks();
                }
            }         
        }
                            ...
                            try {
                                ...
                                if(i!= -1){
                                    Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                                        ...
                                        "hasil_endoskopi_telinga='"+tbUser.getValueAt(i,1021).toString()+"',"+
                                        "pemantauan_pews_maternal='"+tbUser.getValueAt(barisdicopy, 1022).toString()+"',"+
                                        "validasi_sbar='"+tbUser.getValueAt(barisdicopy, 1023).toString()+"'");
                                }
                                userdicopy="";
                                copyhakakses="";
                                barisdicopy=-1;
