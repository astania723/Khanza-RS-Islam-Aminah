       ...
       Valid.tabelKosong(tabMode);
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    (TCari.getText().trim().isEmpty()?"":" and (tokoreturpiutang.no_retur_piutang like '%"+TCari.getText()+"%' or tokoreturpiutang.no_member like '%"+TCari.getText()+"%' or tokomember.nama like '%"+TCari.getText()+"%' or "+
