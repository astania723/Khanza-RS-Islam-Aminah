       ...
       Valid.tabelKosong(tabMode);
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    (TCari.getText().trim().isEmpty()?"":" and (tokoreturjual.no_retur_jual like '%"+TCari.getText()+"%' or tokoreturjual.no_member like '%"+TCari.getText()+"%' or tokomember.nama like '%"+TCari.getText()+"%' or "+
