        ...
        if(TabRawat.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                Valid.MyReportqry("rptKeuntunganBarangToko1.jasper","report","::[ Keuntungan Penjualan Barang Toko ]::",
                    ...
                    (TCari.getText().trim().isEmpty()?"":" and (tokobarang.nama_brng like '%"+TCari.getText()+"%' or tokopenjualan.nota_jual like '%"+TCari.getText()+"%' or toko_detail_jual.kode_brng like '%"+TCari.getText()+"%' )")+
            ...
            if(tabMode2.getRowCount()==0){
                ...
                Valid.MyReportqry("rptKeuntunganBarangToko2.jasper","report","::[ Keuntungan Piutang Barang Toko ]::",
                    ...
                    (TCari.getText().trim().isEmpty()?"":" and (tokobarang.nama_brng like '%"+TCari.getText()+"%' or tokopiutang.nota_piutang like '%"+TCari.getText()+"%' or toko_detail_piutang.kode_brng like '%"+TCari.getText()+"%' )")+
    ...
    public void tampil(){        
        try {
            ...
            ps=koneksi.prepareStatement(
                ...
                "inner join tokobarang on toko_detail_jual.kode_brng=tokobarang.kode_brng "+
                "inner join kodesatuan on toko_detail_jual.kode_sat=kodesatuan.kode_sat "+
                "where tokopenjualan.tgl_jual between ? and ? "+(TCari.getText().trim().isEmpty()?"":" and (tokobarang.nama_brng like ? or tokopenjualan.nota_jual like ? or toko_detail_jual.kode_brng like ? )")+
    ...
    public void tampil2(){        
        try {
            ...
            ps=koneksi.prepareStatement(
                ...
                "inner join tokobarang on toko_detail_piutang.kode_brng=tokobarang.kode_brng "+
                "inner join kodesatuan on toko_detail_piutang.kode_sat=kodesatuan.kode_sat "+
                "where tokopiutang.tgl_piutang between ? and ? "+(TCari.getText().trim().isEmpty()?"":" and (tokobarang.nama_brng like ? or tokopiutang.nota_piutang like ? or toko_detail_piutang.kode_brng like ? )")+
