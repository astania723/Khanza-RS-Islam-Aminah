    ...
    */
    ...
    private void tampil() {
        ...
        try {
                ...
                while(rs.next()){
                    ...
                    try {
                        ...
                        if(rspenerimaan.next()){
                           ...
                           htmlContent.append("<tr class='isi'><td valign='middle' bgcolor='#FFFFF8' align='left' colspan='2'>No.Pemesanan</td><td valign='middle' colspan='7'>: ").append(rs.getString("no_pemesanan")).append("</td><td valign='middle' bgcolor='#FFF8FF' align='left' colspan='3'>No.Faktur</td><td valign='middle' colspan='4'>: ").append(rspenerimaan.getString("no_faktur")).append("</td><td valign='middle' align='center'>Tgl.Faktur : ").append(rspenerimaan.getString("tgl_faktur")).append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFFF8' align='left' colspan='2'>Tgl.Pemesanan</td><td valign='middle' colspan='7'>: ").append(rs.getString("tanggal")).append("</td><td valign='middle' bgcolor='#FFF8FF' align='left' colspan='3'>Tgl.Penerimaan</td><td valign='middle' colspan='4'>: ").append(rspenerimaan.getString("tanggal")).append("</td><td valign='middle' align='center'>Lama : ").append(rspenerimaan.getString("lama")).append(" Hari</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFFF8' align='left' colspan='2'>Suplier</td><td valign='middle' colspan='7'>: ").append(rs.getString("nama_suplier")).append("</td><td valign='middle' bgcolor='#FFF8FF' align='left' colspan='3'>Jatuh Tempo</td><td valign='middle' colspan='4'>: ").append(rspenerimaan.getString("tgl_tempo")).append("</td><td valign='middle' align='center'>Status : ").append(rspenerimaan.getString("status")).append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFFF8' align='left' colspan='2'>Petugas</td><td valign='middle' colspan='7'>: ").append(rs.getString("nip")).append(" ").append(rs.getString("nama")).append("</td><td valign='middle' bgcolor='#FFF8FF' align='left' colspan='3'>Penerima</td><td valign='middle' colspan='4'>: ").append(rspenerimaan.getString("nip")).append(" ").append(rspenerimaan.getString("nama")).append("</td><td valign='middle' align='center'>Depo : ").append(rspenerimaan.getString("nm_bangsal")).append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFFF8' align='center' width='5%'>Kode Barang</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='14%'>Nama Barang</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='3%'>Satuan</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='1%'>Jml</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='5%'>Harga(Rp)</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='6%'>SubTotal(Rp)</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='4%'>Disk(%)</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='5%'>Disk(Rp)</td><td valign='middle' bgcolor='#FFFFF8' align='center' width='7%'>Total(Rp)</td><td valign='middle' bgcolor='#FFF8FF' align='center' width='3%'>Satuan</td><td valign='middle' bgcolor='#FFF8FF' align='center' width='2%'>Jml</td><td valign='middle' bgcolor='#FFF8FF' align='center' width='5%'>Harga(Rp)</td><td valign='middle' bgcolor='#FFF8FF' align='center' width='7%'>SubTotal(Rp)</td><td valign='middle' bgcolor='#FFF8FF' align='center' width='4%'>Disk(%)</td><td valign='middle' bgcolor='#FFF8FF' align='center' width='6%'>Disk(Rp)</td><td valign='middle' bgcolor='#FFF8FF' align='center' width='8%'>Total(Rp)</td><td valign='middle' bgcolor='#FFF8F8' align='center' width='15%'>Index Ketepatan</td></tr>");
                            ...
                            try {
                                ...
                                while(rssub.next()){
                                    ...
                                    indextotal += index;
                                    jmlindextotal += index;
                                    htmlContent.append("<tr class='isi'><td align='center'>").append(rssub.getString("kode_brng")).append("</td><td align='left'>").append(rssub.getString("nama_brng")).append("</td><td align='center'>").append(rssub.getString("satuan")).append("</td><td align='center'>").append(rssub.getString("jumlah")).append("</td><td align='right'>").append(Valid.SetAngka(rssub.getDouble("h_pesan"))).append("</td><td align='right'>").append(Valid.SetAngka(rssub.getDouble("subtotal"))).append("</td><td align='center'>").append(Valid.SetAngka(rssub.getDouble("dis"))).append("</td><td align='right'>").append(Valid.SetAngka(rssub.getDouble("besardis"))).append("</td><td align='right'>").append(Valid.SetAngka(rssub.getDouble("total"))).append("</td><td align='center'>").append(satuan).append("</td><td align='center'>").append(jumlah).append("</td><td align='right'>").append(Valid.SetAngka(h_pesan)).append("</td><td align='right'>").append(Valid.SetAngka(subtotal)).append("</td><td align='center'>").append(Valid.SetAngka(dis)).append("</td><td align='right'>").append(Valid.SetAngka(besardis)).append("</td><td align='right'>").append(Valid.SetAngka(total)).append("</td><td align='center'>").append(index).append(" (").append(status).append(")</td></tr>");  
                                    i++;
                                    jmli++;
                                }
                            } catch (Exception e) {
                            ...
                            htmlContent.append("<tr class='isi'><td align='right' colspan='4'>Sisipan :</td><td align='right' colspan='2'></td><td align='right' colspan='2'></td><td align='right'></td><td align='right' colspan='2'></td><td align='right' colspan='2'>").append(Valid.SetAngka(sisipantotal1)).append("</td><td align='right' colspan='2'>").append(Valid.SetAngka(sisipanpotongan)).append("</td><td align='right'>").append(Valid.SetAngka(sisipantotal2)).append("</td><td align='center'>").append(index).append(" (").append(status).append(")</td></tr><tr class='isi'><td align='right' colspan='4'>Total : </td><td align='right' colspan='2'>").append(Valid.SetAngka(rs.getDouble("total1"))).append("</td><td align='right' colspan='2'>").append(Valid.SetAngka(rs.getDouble("potongan"))).append("</td><td align='right'>").append(Valid.SetAngka(rs.getDouble("total2"))).append("</td><td align='right' colspan='2'></td><td align='right' colspan='2'>").append(Valid.SetAngka(rspenerimaan.getDouble("total1"))).append("</td><td align='right' colspan='2'>").append(Valid.SetAngka(rspenerimaan.getDouble("potongan"))).append("</td><td align='right'>").append(Valid.SetAngka(rspenerimaan.getDouble("total2"))).append("</td><td align='center'>").append(indextotal).append("</td></tr><tr class='isi'><td align='right' colspan='4'>PPN : </td><td align='right' colspan='4'></td><td align='right'>").append(Valid.SetAngka(rs.getDouble("ppn"))).append("</td><td align='right' colspan='2'></td><td align='right' colspan='4'></td><td align='right'>").append(Valid.SetAngka(rspenerimaan.getDouble("ppn"))).append("</td><td align='center' valign='middle' bgcolor='#FFF8F8' rowspan='3'>").append(Math.round(((indextotal/(i*2))*100))).append(" %</td></tr><tr class='isi'><td align='right' colspan='4'>Meterai : </td><td align='right' colspan='4'></td><td align='right'>").append(Valid.SetAngka(rs.getDouble("meterai"))).append("</td><td align='right' colspan='2'></td><td align='right' colspan='4'></td><td align='right'>").append(Valid.SetAngka(rspenerimaan.getDouble("meterai"))).append("</td></tr><tr class='isi'><td align='right' colspan='4'>Total Tagihan : </td><td align='right' colspan='4'></td><td align='right'>").append(Valid.SetAngka(rs.getDouble("tagihan"))).append("</td><td align='right' colspan='2'></td><td align='right' colspan='4'></td><td align='right'>").append(Valid.SetAngka(rspenerimaan.getDouble("tagihan"))).append("</td></tr><tr class='isi'><td bgcolor='#FFFCFB' colspan='18'></td></tr>");
            ...
            htmlContent.append("<tr class='isi'><td align='center' valign='middle' bgcolor='#FFFAFA' colspan='4'>Jml.Total Tagihan : ").append(Valid.SetAngka(jmltotaltagihan)).append("</td><td align='center' valign='middle' bgcolor='#FFFAFA' colspan='2'>Jumlah Faktur : ").append(jmlfaktur).append("</td><td align='center' valign='middle' bgcolor='#FFFAFA' colspan='4'>Jml.Total Sisipan : ").append(Valid.SetAngka(jmlsisipan)).append("</td><td align='center' valign='middle' bgcolor='#FFFAFA' colspan='3'>Faktur Sisipan : ").append(faktursisipan).append("</td><td align='center' valign='middle' bgcolor='#FFFAFA' colspan='2'>Kirim Rata-rata : ").append(Math.round(jmlharikirim/jmlfaktur)).append(" Hari</td><td align='center' valign='middle' bgcolor='#FFFAFA' colspan='2'>Ketepatan Kirim : ").append(Math.round(((jmlindextotal/(jmli*2))*100))).append(" %</td></tr>");
