...
public class DlgBarang extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
        ...
        } else if (kdsat.getText().trim().isEmpty() || nmsat.getText().trim().isEmpty()) {
            Valid.textKosong(kdsat, "Satuan");
        } else if (kdjns.getText().trim().isEmpty() || nmjns.getText().trim().isEmpty()) {
            Valid.textKosong(kdjns, "Jenis");
        } else if (kdkategori.getText().trim().isEmpty() || nmkategori.getText().trim().isEmpty()) {
            Valid.textKosong(kdkategori, "Kategori");
        } else if (kdgolongan.getText().trim().isEmpty() || nmgolongan.getText().trim().isEmpty()) {
        ...
        } else if (KdIF.getText().trim().isEmpty() || NmIF.getText().trim().isEmpty()) {
            ...
            if(Valid.editTabletf(tabMode, "databarang", "kode_brng", "?", "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                ...
                tbObat.setValueAt(Double.valueOf(Isi.getText()),tbObat.getSelectedRow(),5);
                tbObat.setValueAt(kdsat.getText(),tbObat.getSelectedRow(),6);
                tbObat.setValueAt(nmsat.getText(),tbObat.getSelectedRow(),7);
                tbObat.setValueAt(Double.valueOf(Kapasitas.getText()),tbObat.getSelectedRow(),8);
                tbObat.setValueAt(Letak.getText(),tbObat.getSelectedRow(),9);
                tbObat.setValueAt(Double.valueOf(dasar.getText()),tbObat.getSelectedRow(),10);
                tbObat.setValueAt(Double.valueOf(beli.getText()),tbObat.getSelectedRow(),11);
                tbObat.setValueAt(Double.valueOf(ralan.getText()),tbObat.getSelectedRow(),12);
                tbObat.setValueAt(Double.valueOf(kelas1.getText()),tbObat.getSelectedRow(),13);
                tbObat.setValueAt(Double.valueOf(kelas2.getText()),tbObat.getSelectedRow(),14);
                tbObat.setValueAt(Double.valueOf(kelas3.getText()),tbObat.getSelectedRow(),15);
                tbObat.setValueAt(Double.valueOf(utama.getText()),tbObat.getSelectedRow(),16);
                tbObat.setValueAt(Double.valueOf(kelasvip.getText()),tbObat.getSelectedRow(),17);
                tbObat.setValueAt(Double.valueOf(kelasvvip.getText()),tbObat.getSelectedRow(),18);
                tbObat.setValueAt(Double.valueOf(beliluar.getText()),tbObat.getSelectedRow(),19);
                tbObat.setValueAt(Double.valueOf(jualbebas.getText()),tbObat.getSelectedRow(),20);
                tbObat.setValueAt(Double.valueOf(karyawan.getText()),tbObat.getSelectedRow(),21);
                tbObat.setValueAt(Double.valueOf(stok_minimal.getText()),tbObat.getSelectedRow(),22);
        ...
        if (Kd.getText().trim().isEmpty()) {
            ...
            if(Sequel.menyimpantf("databarang", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Kode Barang", 26, new String[]{
                ...
                tabMode.addRow(new Object[]{
                    false,Kd.getText(),Nm.getText(),kdsatBesar.getText(),nmsatBesar.getText(),Double.valueOf(Isi.getText()),kdsat.getText(),nmsat.getText(),
                    Double.valueOf(Kapasitas.getText()),Letak.getText(),Double.valueOf(dasar.getText()),Double.valueOf(beli.getText()),
                    Double.valueOf(ralan.getText()),Double.valueOf(kelas1.getText()),Double.valueOf(kelas2.getText()),Double.valueOf(kelas3.getText()),
                    Double.valueOf(utama.getText()),Double.valueOf(kelasvip.getText()),Double.valueOf(kelasvvip.getText()),Double.valueOf(beliluar.getText()),
                    Double.valueOf(jualbebas.getText()),Double.valueOf(karyawan.getText()),Double.valueOf(stok_minimal.getText()),kdjns.getText(),nmjns.getText(),
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            if(tbObat.getValueAt(row, 25).toString().isEmpty()||(tbObat.getValueAt(row, 25).toString().length()==0)){
                ChkKadaluarsa.setSelected(false);
                DTPExpired.setDate(new Date());
            }else{
                ChkKadaluarsa.setSelected(true);
