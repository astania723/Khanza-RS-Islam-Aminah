...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    if(tbDokter.getSelectedRow()!= -1){  
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),10).toString().trim().isEmpty()){
    ...
    private void tampil2() {
        try {
            ...
            try {
                ...
                tagihan=0;
                while(rs.next()){
                    htmlContent.append("<tr class='isi'><td valign='top' align='center'>").append(rs.getString("no_faktur")).append("</td><td valign='top' align='center'>").append(rs.getString("tgl_faktur")).append("</td><td valign='top' align='center'>").append(rs.getString("tgl_pesan")).append("</td><td valign='top' align='center'>").append(rs.getString("tgl_tempo")).append("</td><td valign='top' align='center'>").append(rs.getString("status")).append("</td><td valign='top' align='left'>").append(rs.getString("kode_suplier")).append(", ").append(rs.getString("nama_suplier")).append("</td><td valign='top' align='left'>").append(rs.getString("nip")).append(", ").append(rs.getString("nama")).append("</td><td valign='top' align='left' colspan='8'>Pengadaan di ").append(rs.getString("nm_bangsal")).append(" :</td><td valign='top' align='right'>").append(rs.getString("total2")).append("</td><td valign='top' align='right'>").append(rs.getString("meterai")).append("</td><td valign='top' align='right'>").append(rs.getString("ppn")).append("</td><td valign='top' align='right'>").append(rs.getString("tagihan")).append("</td></tr>");  
                    ...
                    try {
                        ...
                        int no=1;
                        while(rs2.next()){
                            htmlContent.append("<tr class='isi'><td valign='top' align='center'>&nbsp;</td><td valign='top' align='left' colspan='2'>").append(no).append(". No.Batch : ").append(rs2.getString("no_batch")).append("</td><td valign='top' align='left' colspan='2'>Exp : ").append(rs2.getString("kadaluarsa")).append("</td><td valign='top' align='left' colspan='2'>I.F. : ").append(rs2.getString("nama_industri")).append("</td><td valign='top' align='left'>").append(rs2.getString("kode_brng")).append(", ").append(rs2.getString("nama_brng")).append("</td><td valign='top' align='center'>").append(rs2.getString("satuan")).append("</td><td valign='top' align='center'>").append(rs2.getString("jumlah")).append("</td><td valign='top' align='right'>").append(rs2.getString("h_pesan")).append("</td><td valign='top' align='right'>").append(rs2.getString("subtotal")).append("</td><td valign='top' align='right'>").append(rs2.getString("dis")).append("</td><td valign='top' align='right'>").append(rs2.getString("besardis")).append("</td><td valign='top' align='right'>").append(rs2.getString("total")).append("</td><td valign='top' align='center'>&nbsp;</td><td valign='top' align='center'>&nbsp;</td><td valign='top' align='center'>&nbsp;</td><td valign='top' align='center'>&nbsp;</td></tr>"); 
                            no++;
                        }                        
                    } catch (Exception e) {
                        System.out.println("Notifikasi : "+e);
