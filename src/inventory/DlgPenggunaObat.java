    ...
    */
    ...
    private void prosesCari() {            
        try{   
            ...
            if(nmjns.getText().isEmpty()&&nmkategori.getText().isEmpty()&&nmgolongan.getText().isEmpty()&&TCari.getText().isEmpty()){
            ...
            if(Status.getSelectedItem().toString().equals("Semua")&&nmpenjab.getText().isEmpty()&nmasal.getText().isEmpty()){
            ...
            try {
                if(nmjns.getText().isEmpty()&&nmkategori.getText().isEmpty()&&nmgolongan.getText().isEmpty()&&TCari.getText().isEmpty()){}else{
