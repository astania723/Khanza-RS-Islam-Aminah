    ...
    */
    ...
    private void tampil() {
       Valid.tabelKosong(tabMode);
        try{  
            if(NoPermintaan.getText().isEmpty()&&NmBangsal.getText().isEmpty()&&NmPeg.getText().isEmpty()&&nmjenis.getText().isEmpty()&&
                 nmkategori.getText().isEmpty()&&nmgolongan.getText().isEmpty()&&nmbar.getText().isEmpty()&&TCari.getText().isEmpty()&&
