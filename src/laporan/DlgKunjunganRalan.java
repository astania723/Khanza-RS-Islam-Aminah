...
public class DlgKunjunganRalan extends javax.swing.JDialog {
    ...
    public DlgKunjunganRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","L","P","Tanggal Lahir","No.Telp","Alamat","Kelurahan","Kecamatan","Kabupaten","Kode","Diagnosa","Dokter Jaga","Poliklinik","Cara Bayar"}){
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","L","P","Tanggal Lahir","No.Telp","Alamat","Kelurahan","Kecamatan","Kabupaten","Kode","Diagnosa","Dokter Jaga","Poliklinik","Cara Bayar"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("tgl_lahir"),rs.getString("no_tlp"),rs.getString("almt_pj"),rs.getString("nm_kel"),rs.getString("nm_kec"),rs.getString("nm_kab"),kddiangnosa,diagnosa,rs.getString("nm_dokter"),rs.getString("nm_poli"),rs.getString("png_jawab")
                    });                
                    i++;
                }
                if(i>=2){
