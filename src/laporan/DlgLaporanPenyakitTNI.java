    ...
    */
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'><td valign='middle' bgcolor='#FFFAFA' align='center' rowspan='2' width='30px'>NO</td><td valign='middle' bgcolor='#FFFAFA' align='center' rowspan='2' width='50px'>ICD 10</td><td valign='middle' bgcolor='#FFFAFA' align='center' rowspan='2' width='200px'>JENIS PENYAKIT</td><td valign='middle' bgcolor='#FFFAFA' align='center' colspan='").append(jumlahcari).append("'>PASIEN TNI</td><td valign='middle' bgcolor='#FFFAFA' align='center' colspan='").append(jumlahcarabayar).append("'>PASIEN UMUM</td><td valign='middle' bgcolor='#FFFAFA' align='center' rowspan='2' width='50px'>Total</td></tr>");
            ...
            try {
                ...
                while(rs.next()){
                    total=0;
                    htmlContent.append("<tr class='isi'><td valign='middle' align='center'>").append(no).append("</td><td valign='middle' align='center'>").append(rs.getString("kd_penyakit")).append("</td><td valign='middle' align='left'>").append(rs.getString("nm_penyakit")).append("</td>");    
        ...
        try {
            ...
            try {
                ...
                while(rs.next()){
                    kodecari[kolom]=rs.getString("id");
                    kolom++;
                    htmlContent.append("<td valign='middle' bgcolor='#FFFFF8' align='center' width='70px'>").append(rs.getString("nama_jabatan")).append("</td>");
                }
            } catch (Exception e) {
                System.out.println("Akun Bayar : "+e);
            } finally{
