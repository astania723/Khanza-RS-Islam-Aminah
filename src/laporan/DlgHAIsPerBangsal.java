            ...
            try {
                ...
                while(rs.next()){
                    if((!rs.getString("nm_bangsal").toLowerCase().contains("apotek"))&&(!rs.getString("nm_bangsal").toLowerCase().contains("gudang"))&&(!rs.getString("nm_bangsal").toLowerCase().contains("depo"))&&(!rs.getString("nm_bangsal").toLowerCase().contains("farmasi"))){
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='center'>").append(i).append("</td><td valign='middle' align='left'>").append(rs.getString("nm_bangsal")).append("</td><td valign='middle' align='center'>").append(pasien).append("</td><td valign='middle' align='center'>").append(ETT).append("</td><td valign='middle' align='center'>").append(CVL).append("</td><td valign='middle' align='center'>").append(IVL).append("</td><td valign='middle' align='center'>").append(UC).append("</td><td valign='middle' align='center'>").append(VAP).append("</td><td valign='middle' align='center'>").append(IAD).append("</td><td valign='middle' align='center'>").append(PLEB).append("</td><td valign='middle' align='center'>").append(ISK).append("</td><td valign='middle' align='center'>").append(ILO).append("</td><td valign='middle' align='center'>").append(HAP).append("</td><td valign='middle' align='center'>").append(Tinea).append("</td><td valign='middle' align='center'>").append(Scabies).append("</td><td valign='middle' align='center'>").append(deku).append("</td><td valign='middle' align='center'>").append(sputum).append("</td><td valign='middle' align='center'>").append(darah).append("</td><td valign='middle' align='center'>").append(urine).append("</td><td valign='middle' align='center'>").append(ANTIBIOTIK).append("</td></tr>"); 
                        i++;
                    }                        
                }
