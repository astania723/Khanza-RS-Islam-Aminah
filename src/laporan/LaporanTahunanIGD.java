    ...
    */
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'><td valign='middle' bgcolor='#FFFAFA' align='center' width='5%'>No</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='65%'>Bulan Pelayanan</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='30%'>Jumlah Pasien</td></tr><tr class='isi'><td valign='middle' align='center'>1.</td><td valign='middle' align='left'>Januari ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(jan).append("</td></tr><tr class='isi'><td valign='middle' align='center'>2.</td><td valign='middle' align='left'>Februari ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(feb).append("</td></tr><tr class='isi'><td valign='middle' align='center'>3.</td><td valign='middle' align='left'>Maret ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(mar).append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFCFB' align='center'>4.</td><td valign='middle' bgcolor='#FFFCFB' align='left'>Tri Wulan I ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' bgcolor='#FFFCFB' align='center'>").append(jan).append(feb).append(mar).append("</td></tr><tr class='isi'><td valign='middle' align='center'>5.</td><td valign='middle' align='left'>April ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(apr).append("</td></tr><tr class='isi'><td valign='middle' align='center'>7.</td><td valign='middle' align='left'>Mei ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(mei).append("</td></tr><tr class='isi'><td valign='middle' align='center'>8.</td><td valign='middle' align='left'>Juni ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(jun).append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFCFB' align='center'>9.</td><td valign='middle' bgcolor='#FFFCFB' align='left'>Tri Wulan II ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' bgcolor='#FFFCFB' align='center'>").append(apr).append(mei).append(jun).append("</td></tr><tr class='isi'><td valign='middle' align='center'>10.</td><td valign='middle' align='left'>Juli ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(jul).append("</td></tr><tr class='isi'><td valign='middle' align='center'>11.</td><td valign='middle' align='left'>Agustus ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(agu).append("</td></tr><tr class='isi'><td valign='middle' align='center'>12.</td><td valign='middle' align='left'>September ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(sep).append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFCFB' align='center'>13.</td><td valign='middle' bgcolor='#FFFCFB' align='left'>Tri Wulan III ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' bgcolor='#FFFCFB' align='center'>").append(jul).append(agu).append(sep).append("</td></tr><tr class='isi'><td valign='middle' align='center'>14.</td><td valign='middle' align='left'>Oktober ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(okt).append("</td></tr><tr class='isi'><td valign='middle' align='center'>15.</td><td valign='middle' align='left'>November ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(nov).append("</td></tr><tr class='isi'><td valign='middle' align='center'>16.</td><td valign='middle' align='left'>Desember ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' align='center'>").append(des).append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFCFB' align='center'>17.</td><td valign='middle' bgcolor='#FFFCFB' align='left'>Tri Wulan IV ").append(ThnCari.getSelectedItem()).append("</td><td valign='middle' bgcolor='#FFFCFB' align='center'>").append(okt).append(nov).append(des).append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFAFA' align='center'>18.</td><td valign='middle' bgcolor='#FFFAFA' align='left'>Total</td><td valign='middle' bgcolor='#FFFAFA' align='center'>").append(jan).append(feb).append(mar).append(apr).append(mei).append(jun).append(jul).append(agu).append(sep).append(okt).append(nov).append(des).append("</td></tr>");    
            LoadHTML.setText(
                    "<html>"+
                      "<table width='100%' border='0' align='left' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                       htmlContent.toString()+
