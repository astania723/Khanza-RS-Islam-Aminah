            ...
            try {
                ...
                while(rs.next()){
                    ...
                    try {
                        ...
                        a=1;
                        while(rs2.next()){
                            htmlContent.append("<tr class='isi'><td valign='top' align='center'>").append(a).append("</td><td valign='top'>").append(rs2.getString("no_peserta")).append("</td><td valign='top'>").append(rs2.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs2.getString("nm_pasien")).append("</td><td valign='top' align='center'>").append(rs2.getString("Umur")).append("</td><td valign='top' align='center'>").append(rs2.getString("jk")).append("</td><td valign='top'>").append(rs2.getString("alamat")).append("</td><td valign='top'>").append(rs2.getString("pekerjaan")).append("</td></tr>");
                            a++;
                        }
                    } catch (Exception e) {
