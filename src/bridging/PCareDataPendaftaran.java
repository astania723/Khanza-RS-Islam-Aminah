...
public class PCareDataPendaftaran extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(KdPoliTujuan.getText().trim().isEmpty()||NmPoliTujuan.getText().trim().isEmpty()){
            Valid.textKosong(btnPoliTujuan,"Poli Tujuan");
        }else if((chkKunjungan.isSelected()==true)&&(NmStatusPulang.getText().isEmpty())){
            Valid.textKosong(BtnStatusPulang,"Status Pulang");
        }else if((chkKunjungan.isSelected()==true)&&(NmTenagaMedis.getText().isEmpty())){
            Valid.textKosong(BtnTenagaMedis,"Tenaga Medis");
        }else if((chkKunjungan.isSelected()==true)&&(NmDiagnosa1.getText().isEmpty())){
    ...
    private void ppJadikanKunjunganBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppJadikanKunjunganBtnPrintActionPerformed
        for(i=0;i<tbPendaftaran.getRowCount();i++){
            if(tbPendaftaran.getValueAt(i,20).toString().equals("Terkirim")){
                ...
                if(TinggiBadan.getText().isEmpty()||TinggiBadan.getText().equals("0")||BeratBadan.getText().isEmpty()||BeratBadan.getText().equals("0")||Sistole.getText().isEmpty()||Diastole.getText().equals("0")||
                    Keluhan.getText().isEmpty()||Keluhan.getText().equals("0")||Diastole.getText().isEmpty()||Diastole.getText().equals("0")||Respiratory.getText().isEmpty()||Respiratory.getText().equals("0")||
                    Heartrate.getText().isEmpty()||Heartrate.getText().equals("0")||KdSadar.getText().isEmpty()||NmSadar.getText().isEmpty()){
                    ...
                    if(KdDiagnosa1.getText().isEmpty()||NmDiagnosa1.getText().isEmpty()){
                        ...
                        if(KdTenagaMedis.getText().isEmpty()||NmTenagaMedis.getText().isEmpty()){
