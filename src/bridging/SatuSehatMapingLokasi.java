...
public class SatuSehatMapingLokasi extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TabRawat.getSelectedIndex()==0){
            ...
            }else if(KodePoli.getText().trim().isEmpty()||NamaPoli.getText().trim().isEmpty()){
            ...
            if(KodeDepartemenKamar.getText().trim().isEmpty()||NamaDepartemenKamar.getText().trim().isEmpty()){
                Valid.textKosong(KodeDepartemenKamar,"Departemen/Organisasi");
            }else if(KodeKamar.getText().trim().isEmpty()||NamaKamar.getText().trim().isEmpty()){
            ...
            if(tabModeRuangOK.getRowCount()==0){
                if(KodeDepartemenRuangOK.getText().trim().isEmpty()||NamaDepartemenRuangOK.getText().trim().isEmpty()){
            ...
            if(tabModeRuangLabPK.getRowCount()==0){
                if(KodeDepartemenRuangLabPK.getText().trim().isEmpty()||NamaDepartemenRuangLabPK.getText().trim().isEmpty()){
            ...
            if(tabModeRuangLabPA.getRowCount()==0){
                if(KodeDepartemenRuangLabPA.getText().trim().isEmpty()||NamaDepartemenRuangLabPA.getText().trim().isEmpty()){
            ...
            if(tabModeRuangLabMB.getRowCount()==0){
                if(KodeDepartemenRuangLabMB.getText().trim().isEmpty()||NamaDepartemenRuangLabMB.getText().trim().isEmpty()){
            ...
            if(tabModeRuangRadiologi.getRowCount()==0){
                if(KodeDepartemenRuangRadiologi.getText().trim().isEmpty()||NamaDepartemenRuangRadiologi.getText().trim().isEmpty()){
            ...
            if(KodeDepartemenFarmasi.getText().trim().isEmpty()||NamaDepartemenFarmasi.getText().trim().isEmpty()){
                Valid.textKosong(KodeDepartemenFarmasi,"Departemen/Organisasi");
            }else if(KodeFarmasi.getText().trim().isEmpty()||NamaFarmasi.getText().trim().isEmpty()){
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select satu_sehat_mapping_lokasi_ralan.kd_poli,poliklinik.nm_poli,satu_sehat_mapping_lokasi_ralan.id_lokasi_satusehat,"+
    ...
    private void tampilkamar() {
        ...
        try{
            ps=koneksi.prepareStatement("select satu_sehat_mapping_lokasi_ranap.kd_kamar,bangsal.nm_bangsal,satu_sehat_mapping_lokasi_ranap.id_lokasi_satusehat,"+
    ...
    private void tampilruangfarmasi() {
        ...
        try{
            ps=koneksi.prepareStatement("select satu_sehat_mapping_lokasi_depo_farmasi.kd_bangsal,bangsal.nm_bangsal,satu_sehat_mapping_lokasi_depo_farmasi.id_lokasi_satusehat,"+
