...
public class BPJSAntreanPerTanggal extends javax.swing.JDialog {
    ...
    private int i=0,tot_belum=0,tot_selesai=0,tot_batal=0,jkn_capaian_angka=0,mjkn_capaian_angka=0,quality_rate_angka=0,quantity_rate_angka=0;
    private double jkn_capaian,mjkn_capaian,jkn_belum,jkn_selesai,mjkn_belum,mjkn_selesai,umum_belum,umum_selesai,sep,quality_rate,quantity_rate;
