...
public class BPJSSuratKontrol extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoRawat.getText().trim().isEmpty()||NoSEP.getText().trim().isEmpty()){
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(R1.isSelected()==true){
                ...
                Valid.MyReportqry("rptBridgingSuratKontrol.jasper","report","::[ Data Surat Kontrol VClaim ]::",
                    ...
                    (TCari.getText().trim().isEmpty()?"":"and (bridging_sep.no_rawat like '%"+TCari.getText().trim()+"%' or bridging_sep.no_sep like '%"+TCari.getText().trim()+"%' or bridging_sep.no_kartu like '%"+TCari.getText().trim()+"%' or "+
        ...
        try {
           if(R1.isSelected()==true){
                ps=koneksi.prepareStatement(
                    ...
                    (TCari.getText().trim().isEmpty()?"":"and (bridging_sep.no_rawat like ? or bridging_sep.no_sep like ? or bridging_sep.no_kartu like ? or "+
    ...
    private boolean isBooking(){
        ...
        if(status==true){
            ...
            status=Sequel.menyimpantf2("booking_registrasi","?,?,?,?,?,?,?,?,?,?,?","Pasien dan Tanggal",11,new String[]{
                ...
                kodedokter,kodepoli,noreg,"BPJ","0",
