...
public class SatuSehatMapingVaksin extends javax.swing.JDialog {
    ...
    */
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement("select satu_sehat_mapping_vaksin.kode_brng,databarang.nama_brng,satu_sehat_mapping_vaksin.vaksin_code,satu_sehat_mapping_vaksin.vaksin_system,"+
                   ...
                   (TCari.getText().isEmpty()?"":"where satu_sehat_mapping_vaksin.kode_brng like ? or databarang.nama_brng like ? or "+
