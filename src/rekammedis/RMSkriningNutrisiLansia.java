        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                try {
                    ...
                    while(rs.next()){
                        htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("nip")).append("</td><td valign='top'>").append(rs.getString("nama")).append("</td><td valign='top'>").append(rs.getString("tanggal")).append("</td><td valign='top'>").append(rs.getString("bb")).append("</td><td valign='top'>").append(rs.getString("tbpb")).append("</td><td valign='top'>").append(rs.getString("td")).append("</td><td valign='top'>").append(rs.getString("hr")).append("</td><td valign='top'>").append(rs.getString("rr")).append("</td><td valign='top'>").append(rs.getString("suhu")).append("</td><td valign='top'>").append(rs.getString("spo2")).append("</td><td valign='top'>").append(rs.getString("alergi")).append("</td><td valign='top'>").append(rs.getString("sg1")).append("</td><td valign='top'>").append(rs.getString("nilai1")).append("</td><td valign='top'>").append(rs.getString("sg2")).append("</td><td valign='top'>").append(rs.getString("nilai2")).append("</td><td valign='top'>").append(rs.getString("sg3")).append("</td><td valign='top'>").append(rs.getString("nilai3")).append("</td><td valign='top'>").append(rs.getString("sg4")).append("</td><td valign='top'>").append(rs.getString("nilai4")).append("</td><td valign='top'>").append(rs.getString("sg5")).append("</td><td valign='top'>").append(rs.getString("nilai5")).append("</td><td valign='top'>").append(rs.getString("sg6")).append("</td><td valign='top'>").append(rs.getString("nilai6")).append("</td><td valign='top'>").append(rs.getString("total_hasil")).append("</td><td valign='top'>").append(rs.getString("skor_nutrisi")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                        "<html>"+
