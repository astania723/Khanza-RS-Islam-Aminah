    ...
    private void prosesCari() {
        ...
        try {
            ...
            if(Pangkat.getText().trim().isEmpty()&&Satuan.getText().trim().isEmpty()&&Golongan.getText().trim().isEmpty()&&
                    Jabatan.getText().trim().isEmpty()&&Poli.getText().trim().isEmpty()&&Dokter.getText().trim().isEmpty()
