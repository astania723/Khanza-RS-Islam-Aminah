            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_kebidanan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",119,new String[]{
                    ...
                    for (i = 0; i < tbMasalahKeperawatanKebidanan.getRowCount(); i++) {
                        if(tbMasalahKeperawatanKebidanan.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_kebidanan_masalah","?,?",2,new String[]{TNoRw.getText(),tbMasalahKeperawatanKebidanan.getValueAt(i,1).toString()});
                        }
                    }
                    for (i = 0; i < tbRencanaKeperawatanKebidanan.getRowCount(); i++) {
                        if(tbRencanaKeperawatanKebidanan.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_kebidanan_rencana","?,?",2,new String[]{TNoRw.getText(),tbRencanaKeperawatanKebidanan.getValueAt(i,1).toString()});
                        }
                    }
                emptTeks();
            }
    ...
    */
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_awal_keperawatan_kebidanan where no_rawat=?",1,new String[]{
            ...
            Sequel.meghapus("penilaian_awal_keperawatan_kebidanan_rencana","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
            ChkAccor.setSelected(false);
            isMenu();
