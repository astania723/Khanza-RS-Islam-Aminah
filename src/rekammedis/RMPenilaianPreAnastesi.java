        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                try {
                    ...
                    while(rs.next()){
                        htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("kd_dokter")).append("</td><td valign='top'>").append(rs.getString("nm_dokter")).append("</td><td valign='top'>").append(rs.getString("tanggal")).append("</td><td valign='top'>").append(rs.getString("tanggal_operasi")).append("</td><td valign='top'>").append(rs.getString("diagnosa")).append("</td><td valign='top'>").append(rs.getString("rencana_tindakan")).append("</td><td valign='top'>").append(rs.getString("tb")).append("</td><td valign='top'>").append(rs.getString("bb")).append("</td><td valign='top'>").append(rs.getString("td")).append("</td><td valign='top'>").append(rs.getString("io2")).append("</td><td valign='top'>").append(rs.getString("nadi")).append("</td><td valign='top'>").append(rs.getString("pernapasan")).append("</td><td valign='top'>").append(rs.getString("suhu")).append("</td><td valign='top'>").append(rs.getString("fisik_cardiovasculer")).append("</td><td valign='top'>").append(rs.getString("fisik_paru")).append("</td><td valign='top'>").append(rs.getString("fisik_abdomen")).append("</td><td valign='top'>").append(rs.getString("fisik_extrimitas")).append("</td><td valign='top'>").append(rs.getString("fisik_endokrin")).append("</td><td valign='top'>").append(rs.getString("fisik_ginjal")).append("</td><td valign='top'>").append(rs.getString("fisik_obatobatan")).append("</td><td valign='top'>").append(rs.getString("fisik_laborat")).append("</td><td valign='top'>").append(rs.getString("fisik_penunjang")).append("</td><td valign='top'>").append(rs.getString("riwayat_penyakit_alergiobat")).append("</td><td valign='top'>").append(rs.getString("riwayat_penyakit_alergilainnya")).append("</td><td valign='top'>").append(rs.getString("riwayat_penyakit_terapi")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_merokok")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_ket_merokok")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_alkohol")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_ket_alkohol")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_obat")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_ket_obat")).append("</td><td valign='top'>").append(rs.getString("riwayat_medis_cardiovasculer")).append("</td><td valign='top'>").append(rs.getString("riwayat_medis_respiratory")).append("</td><td valign='top'>").append(rs.getString("riwayat_medis_endocrine")).append("</td><td valign='top'>").append(rs.getString("riwayat_medis_lainnya")).append("</td><td valign='top'>").append(rs.getString("asa")).append("</td><td valign='top'>").append(rs.getString("puasa")).append("</td><td valign='top'>").append(rs.getString("rencana_anestesi")).append("</td><td valign='top'>").append(rs.getString("rencana_perawatan")).append("</td><td valign='top'>").append(rs.getString("catatan_khusus")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                        "<html>"+
