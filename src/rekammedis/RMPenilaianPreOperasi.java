        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                try {
                    ...
                    while(rs.next()){
                        htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("kd_dokter")).append("</td><td valign='top'>").append(rs.getString("nm_dokter")).append("</td><td valign='top'>").append(rs.getString("tanggal")).append("</td><td valign='top'>").append(rs.getString("ringkasan_klinik")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_fisik")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_diagnostik")).append("</td><td valign='top'>").append(rs.getString("diagnosa_pre_operasi")).append("</td><td valign='top'>").append(rs.getString("rencana_tindakan_bedah")).append("</td><td valign='top'>").append(rs.getString("hal_hal_yang_perludi_persiapkan")).append("</td><td valign='top'>").append(rs.getString("terapi_pre_operasi")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                        "<html>"+
