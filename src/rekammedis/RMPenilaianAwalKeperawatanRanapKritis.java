...
public class RMPenilaianAwalKeperawatanRanapKritis extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanRanapKritis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Nadi(x/menit)","RR(x/menit)","Suhu(°C)","SpO2(%)","BB(Kg)","TB(cm)","A. Jalan Nafar","A. Berupa","A. Pernapasan","A. Dengan","A. ETT/Tracheocanule","A. Cuff","A. Frekuensi","A. Irama",
  ...
  private void initComponents() {
    ...
    BloodSirkulasiPeriferTekananDarahA = new widget.TextBox();
    ...
    BloodSirkulasiPeriferTekananDarahB = new widget.TextBox();
    ...
    TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-01-2024 07:55:24" }));
    ...
    DiagnosaKhususGizi.setBounds(200, 3230, 80, 23);
    ...
    jLabel159.setBounds(160, 800, 10, 23);

    BloodSirkulasiPeriferTekananDarahA.setFocusTraversalPolicyProvider(true);
    BloodSirkulasiPeriferTekananDarahA.setName("BloodSirkulasiPeriferTekananDarahA"); // NOI18N
    FormInput.add(BloodSirkulasiPeriferTekananDarahA);
    BloodSirkulasiPeriferTekananDarahA.setBounds(120, 800, 40, 23);
    ...
    BloodSirkulasiPeriferTekananDarahB.setFocusTraversalPolicyProvider(true);
    BloodSirkulasiPeriferTekananDarahB.setName("BloodSirkulasiPeriferTekananDarahB"); // NOI18N
    FormInput.add(BloodSirkulasiPeriferTekananDarahB);
    BloodSirkulasiPeriferTekananDarahB.setBounds(170, 800, 40, 23);
    ...
    BloodSirkulasiJantungKeluhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lelah", "Berdebar-debar", "Kesemutan", "Keringan dingin", "Gemetaran" }));
    ...
    BloodHematologiPendarahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Gusi mudah berdarah", "Mimisan", "Petechie", "Echimosis", "Terus menerus", "Kemah", "Pucat" }));
    ...
    BrainSirkulasiSerebralPalkososial.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sedih/murung", "Menyendiri", "Kebersihan diri kurang", "Ekspresi wajah datar", "Ekspresi wajah tegang", "Mata merah", "Marah-marah", "Bicara sendiri", "Gelisah/monda-mandir" }));
    ...
    TipePersalinan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Spontan", "Induksi", "Forcep", "Vacumm", "SC" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().isEmpty()){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_ranap_kritis","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",206,new String[]{
                    ...
                    BloodSirkulasiPeriferTekananDarahA.getText(),BloodSirkulasiPeriferTekananDarahB.getText(),BloodSirkulasiPeriferMAP.getText(),BloodSirkulasiPeriferCVP.getText(),BloodSirkulasiPeriferIBP.getText(),BloodSirkulasiPeriferAkral.getSelectedItem().toString(), 
  ...
  private widget.TextBox BloodSirkulasiPeriferTekananDarahA;
  private widget.TextBox BloodSirkulasiPeriferTekananDarahB;
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            if(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString().contains("TAK")){
                BreathingJalanNafas.setSelectedItem("TAK");
            }else if(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString().contains("Hydrocephalus")){
                BreathingJalanNafas.setSelectedItem("Hydrocephalus");
            }else if(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString().contains("Hematoma")){
                BreathingJalanNafas.setSelectedItem("Hematoma");
            }else{
                BreathingJalanNafas.setSelectedItem("Lain-lain");
            }
            KetSistemSarafKepala.setText(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString().replaceAll(BreathingJalanNafas.getSelectedItem().toString()+", ",""));
