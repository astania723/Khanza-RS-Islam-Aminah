        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                try {
                    ...
                    while(rs.next()){
                        htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("tanggal")).append("</td><td valign='top'>").append(rs.getString("sncn")).append("</td><td valign='top'>").append(rs.getString("tindakan")).append("</td><td valign='top'>").append(rs.getString("kd_dokter_bedah")).append("</td><td valign='top'>").append(rs.getString("dokterbedah")).append("</td><td valign='top'>").append(rs.getString("kd_dokter_anestesi")).append("</td><td valign='top'>").append(rs.getString("dokteranestesi")).append("</td><td valign='top'>").append(rs.getString("verbal_identitas")).append("</td><td valign='top'>").append(rs.getString("verbal_tindakan")).append("</td><td valign='top'>").append(rs.getString("verbal_area_insisi")).append("</td><td valign='top'>").append(rs.getString("penandaan_area_operasi")).append("</td><td valign='top'>").append(rs.getString("lama_operasi")).append("</td><td valign='top'>").append(rs.getString("penayangan_radiologi")).append("</td><td valign='top'>").append(rs.getString("penayangan_ctscan")).append("</td><td valign='top'>").append(rs.getString("penayangan_mri")).append("</td><td valign='top'>").append(rs.getString("antibiotik_profilaks")).append("</td><td valign='top'>").append(rs.getString("nama_antibiotik")).append("</td><td valign='top'>").append(rs.getString("jam_pemberian")).append("</td><td valign='top'>").append(rs.getString("antisipasi_kehilangan_darah")).append("</td><td valign='top'>").append(rs.getString("hal_khusus")).append("</td><td valign='top'>").append(rs.getString("hal_khusus_diperhatikan")).append("</td><td valign='top'>").append(rs.getString("tanggal_steril")).append("</td><td valign='top'>").append(rs.getString("petujuk_sterilisasi")).append("</td><td valign='top'>").append(rs.getString("verifikasi_preoperatif")).append("</td><td valign='top'>").append(rs.getString("nip_perawat_ok")).append("</td><td valign='top'>").append(rs.getString("nama")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                        "<html>"+
