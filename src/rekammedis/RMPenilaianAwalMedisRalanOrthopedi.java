        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                try {
                    ...
                    while(rs.next()){
                        htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("kd_dokter")).append("</td><td valign='top'>").append(rs.getString("nm_dokter")).append("</td><td valign='top'>").append(rs.getString("tanggal")).append("</td><td valign='top'>").append(rs.getString("anamnesis")).append("</td><td valign='top'>").append(rs.getString("hubungan")).append("</td><td valign='top'>").append(rs.getString("keluhan_utama")).append("</td><td valign='top'>").append(rs.getString("rps")).append("</td><td valign='top'>").append(rs.getString("rpd")).append("</td><td valign='top'>").append(rs.getString("rpo")).append("</td><td valign='top'>").append(rs.getString("alergi")).append("</td><td valign='top'>").append(rs.getString("kesadaran")).append("</td><td valign='top'>").append(rs.getString("status")).append("</td><td valign='top'>").append(rs.getString("td")).append("</td><td valign='top'>").append(rs.getString("nadi")).append("</td><td valign='top'>").append(rs.getString("suhu")).append("</td><td valign='top'>").append(rs.getString("rr")).append("</td><td valign='top'>").append(rs.getString("bb")).append("</td><td valign='top'>").append(rs.getString("nyeri")).append("</td><td valign='top'>").append(rs.getString("gcs")).append("</td><td valign='top'>").append(rs.getString("kepala")).append("</td><td valign='top'>").append(rs.getString("thoraks")).append("</td><td valign='top'>").append(rs.getString("abdomen")).append("</td><td valign='top'>").append(rs.getString("ekstremitas")).append("</td><td valign='top'>").append(rs.getString("genetalia")).append("</td><td valign='top'>").append(rs.getString("columna")).append("</td><td valign='top'>").append(rs.getString("muskulos")).append("</td><td valign='top'>").append(rs.getString("lainnya")).append("</td><td valign='top'>").append(rs.getString("ket_lokalis")).append("</td><td valign='top'>").append(rs.getString("lab")).append("</td><td valign='top'>").append(rs.getString("rad")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan")).append("</td><td valign='top'>").append(rs.getString("diagnosis")).append("</td><td valign='top'>").append(rs.getString("diagnosis2")).append("</td><td valign='top'>").append(rs.getString("permasalahan")).append("</td><td valign='top'>").append(rs.getString("terapi")).append("</td><td valign='top'>").append(rs.getString("tindakan")).append("</td><td valign='top'>").append(rs.getString("edukasi")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                        "<html>"+
