...
public class MasterMasalahKeperawatanKebidanan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().isEmpty()){
            ...
            if(Sequel.menyimpantf("master_masalah_keperawatan_kebidanan","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode")==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,TKd,"master_masalah_keperawatan_kebidanan","kode_masalah")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().isEmpty()){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("master_masalah_keperawatan_kebidanan","kode_masalah=?","kode_masalah=?,nama_masalah=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMasalahKeperawatanKebidanan dialog = new MasterMasalahKeperawatanKebidanan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_masalah_keperawatan_kebidanan where master_masalah_keperawatan_kebidanan.kode_masalah like ? or master_masalah_keperawatan_kebidanan.nama_masalah like ? order by master_masalah_keperawatan_kebidanan.kode_masalah");
            try {
