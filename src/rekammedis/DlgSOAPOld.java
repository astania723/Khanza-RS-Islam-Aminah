                ...
                while(rs.next()){
                    ...
                    try {
                        ...
                        if(rs2.next()){
                            ...
                            while(rs2.next()){
                                ...
                                bagian=Sequel.cariIsi("SELECT kd_dokter FROM dokter WHERE kd_dokter='"+rs2.getString("nip")+"'");
                                ...
                                if(!bagian.isEmpty()){
                                 ...
                                 htmlContent.append("<tr class='isi'><td align='center' ").append(stylee).append(" >").append(rs2.getString("tgl_perawatan")).append("<br>").append(rs2.getString("jam_rawat")).append("</td><td valign='top'  ").append(stylee).append(" >").append(rs2.getString("nama")).append("</td><td align='left' ").append(stylee).append(" >").append(rs2.getString("keluhan")).append("</td><td align='left' ").append(stylee).append(">").append(rs2.getString("pemeriksaan")).append("</td><td align='left' ").append(stylee).append(">").append(rs2.getString("penilaian")).append("</td><td align='left' ").append(stylee).append(">").append(rs2.getString("rtl")).append("</td><td align='left' ").append(stylee).append(">").append(rs2.getString("instruksi")).append("</td><td align='left' ").append(stylee).append(">").append(rs2.getString("evaluasi")).append("</td></tr>"); 
                            } 
                        }       
                    } catch (Exception e) {
                    ...
                    try {
                        rs2=koneksi.prepareStatement(
                                ...
                                "from pemeriksaan_ranap inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id where pemeriksaan_ranap.no_rawat='"+rs.getString("no_rawat")+"' "+
