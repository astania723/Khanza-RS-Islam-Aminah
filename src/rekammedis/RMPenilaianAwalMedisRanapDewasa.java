...
public class RMPenilaianAwalMedisRanapDewasa extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRanapDewasa(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Ket.Paru","Ket.Abdomen","Ket.Genital","Ket.Ekstremitas","Ket.Kulit","Ket.Status Lokalis","Laboratorium","Radiologi","Penunjang Lainnya","Diagnosis/Asesmen","Tatalaksana","Edukasi"
        }){
        ...
        KetMata.setDocument(new batasInput((int)5000).getKata(KetMata));
        KetGigi.setDocument(new batasInput((int)5000).getKata(KetGigi));
        KetTht.setDocument(new batasInput((int)5000).getKata(KetTht));
        KetThoraks.setDocument(new batasInput((int)5000).getKata(KetThoraks));
        KetJantung.setDocument(new batasInput((int)5000).getKata(KetJantung));
        KetParu.setDocument(new batasInput((int)5000).getKata(KetParu));
        KetAbdomen.setDocument(new batasInput((int)5000).getKata(KetAbdomen));
        KetGenital.setDocument(new batasInput((int)5000).getKata(KetGenital));
        KetEkstremitas.setDocument(new batasInput((int)5000).getKata(KetEkstremitas));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().isEmpty()){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",50,new String[]{
                    ...
                    KetKulit.getText(),KetLokalis.getText(),Laborat.getText(),Radiologi.getText(),Penunjang.getText(),Diagnosis.getText(),Tatalaksana.getText(),Edukasi.getText()
                })==true){
                    emptTeks();
            }
        }
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
			    ...
			    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='300px'><b>Tatalaksana</b></td>"+
                    ...
                    while(rs.next()){
                        htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("kd_dokter")).append("</td><td valign='top'>").append(rs.getString("nm_dokter")).append("</td><td valign='top'>").append(rs.getString("tanggal")).append("</td><td valign='top'>").append(rs.getString("anamnesis")).append("</td><td valign='top'>").append(rs.getString("hubungan")).append("</td><td valign='top'>").append(rs.getString("keluhan_utama")).append("</td><td valign='top'>").append(rs.getString("rps")).append("</td><td valign='top'>").append(rs.getString("rpd")).append("</td><td valign='top'>").append(rs.getString("rpk")).append("</td><td valign='top'>").append(rs.getString("rpo")).append("</td><td valign='top'>").append(rs.getString("alergi")).append("</td><td valign='top'>").append(rs.getString("keadaan")).append("</td><td valign='top'>").append(rs.getString("gcs")).append("</td><td valign='top'>").append(rs.getString("kesadaran")).append("</td><td valign='top'>").append(rs.getString("td")).append("</td><td valign='top'>").append(rs.getString("nadi")).append("</td><td valign='top'>").append(rs.getString("rr")).append("</td><td valign='top'>").append(rs.getString("suhu")).append("</td><td valign='top'>").append(rs.getString("spo")).append("</td><td valign='top'>").append(rs.getString("bb")).append("</td><td valign='top'>").append(rs.getString("tb")).append("</td><td valign='top'>").append(rs.getString("kepala")).append("</td><td valign='top'>").append(rs.getString("mata")).append("</td><td valign='top'>").append(rs.getString("gigi")).append("</td><td valign='top'>").append(rs.getString("tht")).append("</td><td valign='top'>").append(rs.getString("thoraks")).append("</td><td valign='top'>").append(rs.getString("jantung")).append("</td><td valign='top'>").append(rs.getString("paru")).append("</td><td valign='top'>").append(rs.getString("abdomen")).append("</td><td valign='top'>").append(rs.getString("genital")).append("</td><td valign='top'>").append(rs.getString("ekstremitas")).append("</td><td valign='top'>").append(rs.getString("kulit")).append("</td><td valign='top'>").append(rs.getString("ket_fisik")).append("</td><td valign='top'>").append(rs.getString("ket_lokalis")).append("</td><td valign='top'>").append(rs.getString("lab")).append("</td><td valign='top'>").append(rs.getString("rad")).append("</td><td valign='top'>").append(rs.getString("penunjang")).append("</td><td valign='top'>").append(rs.getString("diagnosis")).append("</td><td valign='top'>").append(rs.getString("tata")).append("</td><td valign='top'>").append(rs.getString("edukasi")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                        "<html>"+
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("ket_jantung"),rs.getString("ket_paru"),rs.getString("ket_abdomen"),rs.getString("ket_genital"),rs.getString("ket_ekstremitas"),rs.getString("ket_kulit"),rs.getString("ket_lokalis"),rs.getString("lab"),
                        rs.getString("rad"),rs.getString("penunjang"),rs.getString("diagnosis"),rs.getString("tata"),rs.getString("edukasi")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap where no_rawat=? and kd_dokter=?",2,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap","no_rawat=? and kd_dokter=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,rpd=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,"+
                "spo=?,bb=?,tb=?,kepala=?,mata=?,gigi=?,tht=?,thoraks=?,jantung=?,paru=?,abdomen=?,genital=?,ekstremitas=?,kulit=?,ket_kepala=?,ket_mata=?,ket_gigi=?,ket_tht=?,ket_thoraks=?,ket_jantung=?,ket_paru=?,ket_abdomen=?,ket_genital=?,ket_ekstremitas=?,ket_kulit=?,ket_lokalis=?,lab=?,rad=?,penunjang=?,diagnosis=?,tata=?,edukasi=?",52,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                    KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPK.getText(),RPO.getText(),Alergi.getText(),Keadaan.getSelectedItem().toString(),GCS.getText(),Kesadaran.getSelectedItem().toString(),TD.getText(),
                    Nadi.getText(),RR.getText(),Suhu.getText(),SPO.getText(),BB.getText(),TB.getText(),Kepala.getSelectedItem().toString(),Mata.getSelectedItem().toString(),Gigi.getSelectedItem().toString(),THT.getSelectedItem().toString(),
                    Thoraks.getSelectedItem().toString(),Jantung.getSelectedItem().toString(),Paru.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Genital.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),
