...
public class RMPenilaianAwalKeperawatanKebidananRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalPersalinan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-06-2023" }));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 2556));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-06-2023 19:28:04" }));
        ...
        HPHT.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-06-2023" }));
        ...
        TP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-06-2023" }));
        ...
        jSeparator8.setBounds(0, 1470, 880, 1);
        ...
        jLabel167.setBounds(10, 1470, 380, 23);
        ...
        PanelWall.setBounds(40, 1490, 320, 130);
        ...
        FormInput.add(Nyeri);
        Nyeri.setBounds(380, 1490, 130, 23);

        jLabel168.setText("Penyebab :");
        jLabel168.setName("jLabel168"); // NOI18N
        FormInput.add(jLabel168);
        jLabel168.setBounds(510, 1490, 60, 23);
        ...
        Provokes.setBounds(580, 1490, 130, 23);
        ...
        Quality.setBounds(430, 1520, 140, 23);
        ...
        jLabel174.setBounds(430, 1600, 60, 23);
        ...
        Durasi.setBounds(720, 1600, 90, 23);
        ...
        NyeriHilang.setBounds(140, 1630, 130, 23);
        ...
        KetPadaDokter.setBounds(780, 1630, 80, 23);
        ...
        jLabel180.setBounds(10, 1660, 380, 23);
        ...
        jLabel181.setBounds(50, 1680, 300, 23);
        ...
        SkalaResiko2.setBounds(430, 1710, 280, 23);
        ...
        NilaiResiko3.setBounds(800, 1740, 60, 23);
        ...
        NilaiResiko4.setBounds(800, 1770, 60, 23);
        ...
        NilaiResiko5.setBounds(800, 1800, 60, 23);
        ...
        NilaiResikoTotal.setBounds(800, 1860, 60, 23);
        ...
        TingkatResiko.setBounds(50, 1890, 810, 23);
        ...
        jSeparator11.setBounds(0, 1920, 880, 1);
        ...
        jLabel201.setBounds(10, 1920, 380, 23);
        ...
        NilaiGizi1.setBounds(800, 1940, 60, 23);
        ...
        SkalaGizi1.setBounds(430, 1940, 320, 23);
        ...
        jLabel204.setBounds(50, 1970, 380, 23);
        ...
        DiagnosaKhususGizi.setBounds(220, 2030, 80, 23);
        ...
        KeteranganDiagnosaKhususGizi.setBounds(300, 2030, 150, 23);
        ...
        jSeparator12.setBounds(0, 2060, 880, 1);
        ...
        TabMasalahKeperawatan.setBounds(10, 2370, 450, 143);
        ...
        TabRencanaKeperawatan.setBounds(470, 2370, 450, 143);

        label12.setText("Key Word :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label12);
        label12.setBounds(40, 2520, 60, 23);
        ...
        TCariMasalah.setBounds(100, 2520, 215, 23);
        ...
        BtnCariMasalah.setBounds(320, 2520, 28, 23);
        ...
        BtnAllMasalah.setBounds(350, 2520, 28, 23);
        ...
        BtnTambahMasalah1.setBounds(380, 2520, 28, 23);

        label13.setText("Key Word :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label13);
        label13.setBounds(500, 2520, 60, 23);
        ...
        TCariRencana.setBounds(560, 2520, 235, 23);
        ...
        BtnCariRencana.setBounds(800, 2520, 28, 23);
        ...
        BtnAllRencana.setBounds(830, 2520, 28, 23);
        ...
        BtnTambahRencana.setBounds(870, 2520, 28, 23);
        ...
        jLabel210.setBounds(40, 2090, 590, 23);
        ...
        jLabel211.setBounds(40, 2110, 260, 23);
        ...
        jLabel212.setBounds(40, 2140, 260, 23);
        ...
        jLabel213.setBounds(40, 2170, 260, 23);
        ...
        jLabel214.setBounds(40, 2200, 260, 23);
        ...
        Kriteria1.setBounds(330, 2110, 80, 23);
        ...
        Kriteria2.setBounds(330, 2140, 80, 23);
        ...
        Kriteria3.setBounds(330, 2170, 80, 23);
        ...
        Kriteria4.setBounds(330, 2200, 80, 23);
        ...
        jLabel215.setBounds(40, 2250, 570, 23);
        ...
        pilihan1.setBounds(50, 2280, 200, 19);
        ...
        pilihan2.setBounds(50, 2300, 180, 19);
        ...
        pilihan3.setBounds(50, 2320, 120, 19);
        ...
        pilihan4.setBounds(50, 2340, 280, 19);
        ...
        pilihan5.setBounds(330, 2280, 120, 19);
        ...
        pilihan6.setBounds(330, 2300, 130, 19);
        ...
        pilihan7.setBounds(330, 2320, 220, 19);
        ...
        pilihan8.setBounds(330, 2340, 370, 19);
        ...
        jLabel289.setBounds(10, 2070, 380, 23);
        ...
        jSeparator13.setBounds(0, 2360, 880, 1);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().isEmpty()){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_kebidanan_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",176,new String[]{
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                                ...
                                while(rs.next()){
                                    htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("nip1")).append("</td><td valign='top'>").append(rs.getString("pengkaji1")).append("</td><td valign='top'>").append(rs.getString("nip2")).append("</td><td valign='top'>").append(rs.getString("pengkaji2")).append("</td><td valign='top'>").append(rs.getString("kd_dokter")).append("</td><td valign='top'>").append(rs.getString("nm_dokter")).append("</td><td valign='top'>").append(rs.getString("tanggal")).append("</td><td valign='top'>").append(rs.getString("informasi")).append("</td><td valign='top'>").append(rs.getString("tiba_diruang_rawat")).append("</td><td valign='top'>").append(rs.getString("cara_masuk")).append("</td><td valign='top'>").append(rs.getString("keluhan")).append("</td><td valign='top'>").append(rs.getString("psk")).append("</td><td valign='top'>").append(rs.getString("rpk")).append("</td><td valign='top'>").append(rs.getString("rp")).append("</td><td valign='top'>").append(rs.getString("alergi")).append("</td><td valign='top'>").append(rs.getString("komplikasi_sebelumnya")).append("</td><td valign='top'>").append(rs.getString("keterangan_komplikasi_sebelumnya")).append("</td><td valign='top'>").append(rs.getString("riwayat_mens_umur")).append("</td><td valign='top'>").append(rs.getString("riwayat_mens_lamanya")).append("</td><td valign='top'>").append(rs.getString("riwayat_mens_banyaknya")).append("</td><td valign='top'>").append(rs.getString("riwayat_mens_siklus")).append("</td><td valign='top'>").append(rs.getString("riwayat_mens_ket_siklus")).append("</td><td valign='top'>").append(rs.getString("riwayat_mens_dirasakan")).append("</td><td valign='top'>").append(rs.getString("riwayat_perkawinan_status")).append("</td><td valign='top'>").append(rs.getString("riwayat_perkawinan_ket_status")).append("</td><td valign='top'>").append(rs.getString("riwayat_perkawinan_usia1")).append("</td><td valign='top'>").append(rs.getString("riwayat_perkawinan_ket_usia1")).append("</td><td valign='top'>").append(rs.getString("riwayat_perkawinan_usia2")).append("</td><td valign='top'>").append(rs.getString("riwayat_perkawinan_ket_usia2")).append("</td><td valign='top'>").append(rs.getString("riwayat_perkawinan_usia3")).append("</td><td valign='top'>").append(rs.getString("riwayat_perkawinan_ket_usia3")).append("</td><td valign='top'>").append(rs.getString("riwayat_persalinan_g")).append("</td><td valign='top'>").append(rs.getString("riwayat_persalinan_p")).append("</td><td valign='top'>").append(rs.getString("riwayat_persalinan_a")).append("</td><td valign='top'>").append(rs.getString("riwayat_persalinan_hidup")).append("</td><td valign='top'>").append(rs.getString("riwayat_hamil_hpht")).append("</td><td valign='top'>").append(rs.getString("riwayat_hamil_usiahamil")).append("</td><td valign='top'>").append(rs.getString("riwayat_hamil_tp")).append("</td><td valign='top'>").append(rs.getString("riwayat_hamil_imunisasi")).append("</td><td valign='top'>").append(rs.getString("riwayat_hamil_anc")).append("</td><td valign='top'>").append(rs.getString("riwayat_hamil_ancke")).append("</td><td valign='top'>").append(rs.getString("riwayat_hamil_ket_ancke")).append("</td><td valign='top'>").append(rs.getString("riwayat_hamil_keluhan_hamil_muda")).append("</td><td valign='top'>").append(rs.getString("riwayat_hamil_keluhan_hamil_tua")).append("</td><td valign='top'>").append(rs.getString("riwayat_kb")).append("</td><td valign='top'>").append(rs.getString("riwayat_kb_lamanya")).append("</td><td valign='top'>").append(rs.getString("riwayat_kb_komplikasi")).append("</td><td valign='top'>").append(rs.getString("riwayat_kb_ket_komplikasi")).append("</td><td valign='top'>").append(rs.getString("riwayat_kb_kapaberhenti")).append("</td><td valign='top'>").append(rs.getString("riwayat_kb_alasanberhenti")).append("</td><td valign='top'>").append(rs.getString("riwayat_genekologi")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_obat")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_ket_obat")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_merokok")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_ket_merokok")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_alkohol")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_ket_alkohol")).append("</td><td valign='top'>").append(rs.getString("riwayat_kebiasaan_narkoba")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_mental")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_keadaan_umum")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_gcs")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_td")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_nadi")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_rr")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_suhu")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_spo2")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_bb")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_tb")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_lila")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_tfu")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_tbj")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_letak")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_presentasi")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_penurunan")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_penurunan")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_his")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_kekuatan")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_lamanya")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_djj")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_ket_djj")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_portio")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_pembukaan")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_ketuban")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_hodge")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_panggul")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_inspekulo")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_ket_inspekulo")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_lakmus")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_ket_lakmus")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_ctg")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_kebidanan_ket_ctg")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_kepala")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_muka")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_mata")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_hidung")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_telinga")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_mulut")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_leher")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_dada")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_perut")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_genitalia")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_umum_ekstrimitas")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_kemampuan_aktifitas")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_berjalan")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_ket_berjalan")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_aktivitas")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_ambulasi")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_ekstrimitas_atas")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_ket_ekstrimitas_atas")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_ekstrimitas_bawah")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_ket_ekstrimitas_bawah")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_kemampuan_menggenggam")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_ket_kemampuan_menggenggam")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_koordinasi")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_ket_koordinasi")).append("</td><td valign='top'>").append(rs.getString("pengkajian_fungsi_gangguan_fungsi")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_kondisipsiko")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_adakah_prilaku")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_ket_adakah_prilaku")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_gangguan_jiwa")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_hubungan_pasien")).append("</td><td valign='top'>").append(rs.getString("agama")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_tinggal_dengan")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_ket_tinggal_dengan")).append("</td><td valign='top'>").append(rs.getString("pekerjaan")).append("</td><td valign='top'>").append(rs.getString("png_jawab")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_budaya")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_ket_budaya")).append("</td><td valign='top'>").append(rs.getString("nama_bahasa")).append("</td><td valign='top'>").append(rs.getString("pnd")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_pend_pj")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_edukasi_pada")).append("</td><td valign='top'>").append(rs.getString("riwayat_psiko_ket_edukasi_pada")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_penyebab")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_ket_penyebab")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_kualitas")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_ket_kualitas")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_lokasi")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_menyebar")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_skala")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_waktu")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_hilang")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_ket_hilang")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_diberitahukan_dokter")).append("</td><td valign='top'>").append(rs.getString("penilaian_nyeri_jam_diberitahukan_dokter")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_skala1")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_nilai1")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_skala2")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_nilai2")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_skala3")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_nilai3")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_skala4")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_nilai4")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_skala5")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_nilai5")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_skala6")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_nilai6")).append("</td><td valign='top'>").append(rs.getString("penilaian_jatuh_totalnilai")).append("</td><td valign='top'>").append(rs.getString("skrining_gizi1")).append("</td><td valign='top'>").append(rs.getString("nilai_gizi1")).append("</td><td valign='top'>").append(rs.getString("skrining_gizi2")).append("</td><td valign='top'>").append(rs.getString("nilai_gizi2")).append("</td><td valign='top'>").append(rs.getString("nilai_total_gizi")).append("</td><td valign='top'>").append(rs.getString("skrining_gizi_diagnosa_khusus")).append("</td><td valign='top'>").append(rs.getString("skrining_gizi_ket_diagnosa_khusus")).append("</td><td valign='top'>").append(rs.getString("skrining_gizi_diketahui_dietisen")).append("</td><td valign='top'>").append(rs.getString("skrining_gizi_jam_diketahui_dietisen")).append("</td><td valign='top'>").append(rs.getString("masalah")).append("</td><td valign='top'>").append(rs.getString("rencana")).append("</td></tr>");
                                }
                        ...
                        case "Laporan 3 (CSV)":
                                ...
                                while(rs.next()){
                                    htmlContent.append("\"").append(rs.getString("no_rawat")).append("\";\" ").append(rs.getString("no_rkm_medis")).append("\";\"").append(rs.getString("nm_pasien")).append("\";\"").append(rs.getString("tgl_lahir")).append("\";\"").append(rs.getString("jk")).append("\";\"").append(rs.getString("nip1")).append("\";\"").append(rs.getString("pengkaji1")).append("\";\"").append(rs.getString("nip2")).append("\";\"").append(rs.getString("pengkaji2")).append("\";\"").append(rs.getString("kd_dokter")).append("\";\"").append(rs.getString("nm_dokter")).append("\";\"").append(rs.getString("tanggal")).append("\";\"").append(rs.getString("informasi")).append("\";\"").append(rs.getString("tiba_diruang_rawat")).append("\";\"").append(rs.getString("cara_masuk")).append("\";\"").append(rs.getString("keluhan")).append("\";\"").append(rs.getString("psk")).append("\";\"").append(rs.getString("rpk")).append("\";\"").append(rs.getString("rp")).append("\";\"").append(rs.getString("alergi")).append("\";\"").append(rs.getString("komplikasi_sebelumnya")).append("\";\"").append(rs.getString("keterangan_komplikasi_sebelumnya")).append("\";\"").append(rs.getString("riwayat_mens_umur")).append("\";\"").append(rs.getString("riwayat_mens_lamanya")).append("\";\"").append(rs.getString("riwayat_mens_banyaknya")).append("\";\"").append(rs.getString("riwayat_mens_siklus")).append("\";\"").append(rs.getString("riwayat_mens_ket_siklus")).append("\";\"").append(rs.getString("riwayat_mens_dirasakan")).append("\";\"").append(rs.getString("riwayat_perkawinan_status")).append("\";\"").append(rs.getString("riwayat_perkawinan_ket_status")).append("\";\"").append(rs.getString("riwayat_perkawinan_usia1")).append("\";\"").append(rs.getString("riwayat_perkawinan_ket_usia1")).append("\";\"").append(rs.getString("riwayat_perkawinan_usia2")).append("\";\"").append(rs.getString("riwayat_perkawinan_ket_usia2")).append("\";\"").append(rs.getString("riwayat_perkawinan_usia3")).append("\";\"").append(rs.getString("riwayat_perkawinan_ket_usia3")).append("\";\"").append(rs.getString("riwayat_persalinan_g")).append("\";\"").append(rs.getString("riwayat_persalinan_p")).append("\";\"").append(rs.getString("riwayat_persalinan_a")).append("\";\"").append(rs.getString("riwayat_persalinan_hidup")).append("\";\"").append(rs.getString("riwayat_hamil_hpht")).append("\";\"").append(rs.getString("riwayat_hamil_usiahamil")).append("\";\"").append(rs.getString("riwayat_hamil_tp")).append("\";\"").append(rs.getString("riwayat_hamil_imunisasi")).append("\";\"").append(rs.getString("riwayat_hamil_anc")).append("\";\"").append(rs.getString("riwayat_hamil_ancke")).append("\";\"").append(rs.getString("riwayat_hamil_ket_ancke")).append("\";\"").append(rs.getString("riwayat_hamil_keluhan_hamil_muda")).append("\";\"").append(rs.getString("riwayat_hamil_keluhan_hamil_tua")).append("\";\"").append(rs.getString("riwayat_kb")).append("\";\"").append(rs.getString("riwayat_kb_lamanya")).append("\";\"").append(rs.getString("riwayat_kb_komplikasi")).append("\";\"").append(rs.getString("riwayat_kb_ket_komplikasi")).append("\";\"").append(rs.getString("riwayat_kb_kapaberhenti")).append("\";\"").append(rs.getString("riwayat_kb_alasanberhenti")).append("\";\"").append(rs.getString("riwayat_genekologi")).append("\";\"").append(rs.getString("riwayat_kebiasaan_obat")).append("\";\"").append(rs.getString("riwayat_kebiasaan_ket_obat")).append("\";\"").append(rs.getString("riwayat_kebiasaan_merokok")).append("\";\"").append(rs.getString("riwayat_kebiasaan_ket_merokok")).append("\";\"").append(rs.getString("riwayat_kebiasaan_alkohol")).append("\";\"").append(rs.getString("riwayat_kebiasaan_ket_alkohol")).append("\";\"").append(rs.getString("riwayat_kebiasaan_narkoba")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_mental")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_keadaan_umum")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_gcs")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_td")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_nadi")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_rr")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_suhu")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_spo2")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_bb")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_tb")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_lila")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_tfu")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_tbj")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_letak")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_presentasi")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_penurunan")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_penurunan")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_his")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_kekuatan")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_lamanya")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_djj")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_ket_djj")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_portio")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_pembukaan")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_ketuban")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_hodge")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_panggul")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_inspekulo")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_ket_inspekulo")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_lakmus")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_ket_lakmus")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_ctg")).append("\";\"").append(rs.getString("pemeriksaan_kebidanan_ket_ctg")).append("\";\"").append(rs.getString("pemeriksaan_umum_kepala")).append("\";\"").append(rs.getString("pemeriksaan_umum_muka")).append("\";\"").append(rs.getString("pemeriksaan_umum_mata")).append("\";\"").append(rs.getString("pemeriksaan_umum_hidung")).append("\";\"").append(rs.getString("pemeriksaan_umum_telinga")).append("\";\"").append(rs.getString("pemeriksaan_umum_mulut")).append("\";\"").append(rs.getString("pemeriksaan_umum_leher")).append("\";\"").append(rs.getString("pemeriksaan_umum_dada")).append("\";\"").append(rs.getString("pemeriksaan_umum_perut")).append("\";\"").append(rs.getString("pemeriksaan_umum_genitalia")).append("\";\"").append(rs.getString("pemeriksaan_umum_ekstrimitas")).append("\";\"").append(rs.getString("pengkajian_fungsi_kemampuan_aktifitas")).append("\";\"").append(rs.getString("pengkajian_fungsi_berjalan")).append("\";\"").append(rs.getString("pengkajian_fungsi_ket_berjalan")).append("\";\"").append(rs.getString("pengkajian_fungsi_aktivitas")).append("\";\"").append(rs.getString("pengkajian_fungsi_ambulasi")).append("\";\"").append(rs.getString("pengkajian_fungsi_ekstrimitas_atas")).append("\";\"").append(rs.getString("pengkajian_fungsi_ket_ekstrimitas_atas")).append("\";\"").append(rs.getString("pengkajian_fungsi_ekstrimitas_bawah")).append("\";\"").append(rs.getString("pengkajian_fungsi_ket_ekstrimitas_bawah")).append("\";\"").append(rs.getString("pengkajian_fungsi_kemampuan_menggenggam")).append("\";\"").append(rs.getString("pengkajian_fungsi_ket_kemampuan_menggenggam")).append("\";\"").append(rs.getString("pengkajian_fungsi_koordinasi")).append("\";\"").append(rs.getString("pengkajian_fungsi_ket_koordinasi")).append("\";\"").append(rs.getString("pengkajian_fungsi_gangguan_fungsi")).append("\";\"").append(rs.getString("riwayat_psiko_kondisipsiko")).append("\";\"").append(rs.getString("riwayat_psiko_adakah_prilaku")).append("\";\"").append(rs.getString("riwayat_psiko_ket_adakah_prilaku")).append("\";\"").append(rs.getString("riwayat_psiko_gangguan_jiwa")).append("\";\"").append(rs.getString("riwayat_psiko_hubungan_pasien")).append("\";\"").append(rs.getString("agama")).append("\";\"").append(rs.getString("riwayat_psiko_tinggal_dengan")).append("\";\"").append(rs.getString("riwayat_psiko_ket_tinggal_dengan")).append("\";\"").append(rs.getString("pekerjaan")).append("\";\"").append(rs.getString("png_jawab")).append("\";\"").append(rs.getString("riwayat_psiko_budaya")).append("\";\"").append(rs.getString("riwayat_psiko_ket_budaya")).append("\";\"").append(rs.getString("nama_bahasa")).append("\";\"").append(rs.getString("pnd")).append("\";\"").append(rs.getString("riwayat_psiko_pend_pj")).append("\";\"").append(rs.getString("riwayat_psiko_edukasi_pada")).append("\";\"").append(rs.getString("riwayat_psiko_ket_edukasi_pada")).append("\";\"").append(rs.getString("penilaian_nyeri")).append("\";\"").append(rs.getString("penilaian_nyeri_penyebab")).append("\";\"").append(rs.getString("penilaian_nyeri_ket_penyebab")).append("\";\"").append(rs.getString("penilaian_nyeri_kualitas")).append("\";\"").append(rs.getString("penilaian_nyeri_ket_kualitas")).append("\";\"").append(rs.getString("penilaian_nyeri_lokasi")).append("\";\"").append(rs.getString("penilaian_nyeri_menyebar")).append("\";\"").append(rs.getString("penilaian_nyeri_skala")).append("\";\"").append(rs.getString("penilaian_nyeri_waktu")).append("\";\"").append(rs.getString("penilaian_nyeri_hilang")).append("\";\"").append(rs.getString("penilaian_nyeri_ket_hilang")).append("\";\"").append(rs.getString("penilaian_nyeri_diberitahukan_dokter")).append("\";\"").append(rs.getString("penilaian_nyeri_jam_diberitahukan_dokter")).append("\";\"").append(rs.getString("penilaian_jatuh_skala1")).append("\";\"").append(rs.getString("penilaian_jatuh_nilai1")).append("\";\"").append(rs.getString("penilaian_jatuh_skala2")).append("\";\"").append(rs.getString("penilaian_jatuh_nilai2")).append("\";\"").append(rs.getString("penilaian_jatuh_skala3")).append("\";\"").append(rs.getString("penilaian_jatuh_nilai3")).append("\";\"").append(rs.getString("penilaian_jatuh_skala4")).append("\";\"").append(rs.getString("penilaian_jatuh_nilai4")).append("\";\"").append(rs.getString("penilaian_jatuh_skala5")).append("\";\"").append(rs.getString("penilaian_jatuh_nilai5")).append("\";\"").append(rs.getString("penilaian_jatuh_skala6")).append("\";\"").append(rs.getString("penilaian_jatuh_nilai6")).append("\";\"").append(rs.getString("penilaian_jatuh_totalnilai")).append("\";\"").append(rs.getString("skrining_gizi1")).append("\";\"").append(rs.getString("nilai_gizi1")).append("\";\"").append(rs.getString("skrining_gizi2")).append("\";\"").append(rs.getString("nilai_gizi2")).append("\";\"").append(rs.getString("nilai_total_gizi")).append("\";\"").append(rs.getString("skrining_gizi_diagnosa_khusus")).append("\";\"").append(rs.getString("skrining_gizi_ket_diagnosa_khusus")).append("\";\"").append(rs.getString("skrining_gizi_diketahui_dietisen")).append("\";\"").append(rs.getString("skrining_gizi_jam_diketahui_dietisen")).append("\";\"").append(rs.getString("masalah")).append("\";\"").append(rs.getString("rencana")).append("\"\n");
                                }
    ...
    */
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Nyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),140).toString());
            Provokes.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),141).toString());
            KetProvokes.setText(tbObat.getValueAt(tbObat.getSelectedRow(),142).toString());
            Quality.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),143).toString());
            KetQuality.setText(tbObat.getValueAt(tbObat.getSelectedRow(),144).toString());
            Lokasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),145).toString());
            Menyebar.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),146).toString());
            SkalaNyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),147).toString());
            Durasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),148).toString());
            NyeriHilang.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),149).toString());
            KetNyeri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),150).toString());
            PadaDokter.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),151).toString());
            KetPadaDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),152).toString());
            SkalaResiko1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),153).toString());
            NilaiResiko1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),154).toString());
            SkalaResiko2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),155).toString());
            NilaiResiko2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),156).toString());
            SkalaResiko3.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),157).toString());
            NilaiResiko3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),158).toString());
            SkalaResiko4.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),159).toString());
            NilaiResiko4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),160).toString());
            SkalaResiko5.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),161).toString());
            NilaiResiko5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),162).toString());
            SkalaResiko6.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),163).toString());
            NilaiResiko6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),164).toString());
            NilaiResikoTotal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),165).toString());
            ...
            Masalah.setText(tbObat.getValueAt(tbObat.getSelectedRow(),187).toString());
            Rencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(),188).toString());
            tampilPersalinan();
    ...
    private void getMasalah() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            DetailMasalah.setText(tbObat.getValueAt(tbObat.getSelectedRow(),187).toString());
            DetailRencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(),188).toString());
    ...
    private void ganti() {
        ...
        if(Sequel.mengedittf("penilaian_awal_keperawatan_kebidanan_ranap","no_rawat=?","no_rawat=?,tanggal=?,informasi=?,tiba_diruang_rawat=?,cara_masuk=?,keluhan=?,rpk=?,psk=?,rp=?,rps=?,robat=?,alergi=?,komplikasi_sebelumnya=?,keterangan_komplikasi_sebelumnya=?,riwayat_mens_umur=?,riwayat_mens_lamanya=?,riwayat_mens_banyaknya=?,riwayat_mens_siklus=?,riwayat_mens_ket_siklus=?,riwayat_mens_dirasakan=?,riwayat_perkawinan_status=?,riwayat_perkawinan_ket_status=?,riwayat_perkawinan_usia1=?,riwayat_perkawinan_ket_usia1=?,riwayat_perkawinan_usia2=?,riwayat_perkawinan_ket_usia2=?,riwayat_perkawinan_usia3=?,riwayat_perkawinan_ket_usia3=?,riwayat_persalinan_g=?,riwayat_persalinan_p=?,riwayat_persalinan_a=?,riwayat_persalinan_hidup=?,riwayat_hamil_hpht=?,riwayat_hamil_usiahamil=?,riwayat_hamil_tp=?,riwayat_hamil_imunisasi=?,riwayat_hamil_anc=?,riwayat_hamil_ancke=?,riwayat_hamil_ket_ancke=?,riwayat_hamil_keluhan_hamil_muda=?,riwayat_hamil_keluhan_hamil_tua=?,riwayat_kb=?,riwayat_kb_lamanya=?,riwayat_kb_komplikasi=?,riwayat_kb_ket_komplikasi=?,riwayat_kb_kapaberhenti=?,riwayat_kb_alasanberhenti=?,riwayat_genekologi=?,riwayat_kebiasaan_obat=?,riwayat_kebiasaan_ket_obat=?,riwayat_kebiasaan_merokok=?,riwayat_kebiasaan_ket_merokok=?,riwayat_kebiasaan_alkohol=?,riwayat_kebiasaan_ket_alkohol=?,riwayat_kebiasaan_narkoba=?,pemeriksaan_kebidanan_mental=?,pemeriksaan_kebidanan_keadaan_umum=?,pemeriksaan_kebidanan_gcs=?,pemeriksaan_kebidanan_td=?,pemeriksaan_kebidanan_nadi=?,pemeriksaan_kebidanan_rr=?,pemeriksaan_kebidanan_suhu=?,pemeriksaan_kebidanan_spo2=?,pemeriksaan_kebidanan_bb=?,pemeriksaan_kebidanan_tb=?,pemeriksaan_kebidanan_lila=?,pemeriksaan_kebidanan_tfu=?,pemeriksaan_kebidanan_tbj=?,pemeriksaan_kebidanan_letak=?,pemeriksaan_kebidanan_presentasi=?,pemeriksaan_kebidanan_penurunan=?,pemeriksaan_kebidanan_his=?,pemeriksaan_kebidanan_kekuatan=?,pemeriksaan_kebidanan_lamanya=?,pemeriksaan_kebidanan_djj=?,pemeriksaan_kebidanan_ket_djj=?,pemeriksaan_kebidanan_portio=?,pemeriksaan_kebidanan_pembukaan=?,pemeriksaan_kebidanan_ketuban=?,pemeriksaan_kebidanan_hodge=?,pemeriksaan_kebidanan_panggul=?,pemeriksaan_kebidanan_inspekulo=?,pemeriksaan_kebidanan_ket_inspekulo=?,pemeriksaan_kebidanan_lakmus=?,pemeriksaan_kebidanan_ket_lakmus=?,pemeriksaan_kebidanan_ctg=?,pemeriksaan_kebidanan_ket_ctg=?,pemeriksaan_umum_kepala=?,pemeriksaan_umum_muka=?,pemeriksaan_umum_mata=?,pemeriksaan_umum_hidung=?,pemeriksaan_umum_telinga=?,pemeriksaan_umum_mulut=?,pemeriksaan_umum_leher=?,pemeriksaan_umum_dada=?,pemeriksaan_umum_perut=?,pemeriksaan_umum_genitalia=?,pemeriksaan_umum_ekstrimitas=?,pengkajian_fungsi_kemampuan_aktifitas=?,pengkajian_fungsi_berjalan=?,pengkajian_fungsi_ket_berjalan=?,pengkajian_fungsi_aktivitas=?,pengkajian_fungsi_ambulasi=?,pengkajian_fungsi_ekstrimitas_atas=?,pengkajian_fungsi_ket_ekstrimitas_atas=?,pengkajian_fungsi_ekstrimitas_bawah=?,pengkajian_fungsi_ket_ekstrimitas_bawah=?,pengkajian_fungsi_kemampuan_menggenggam=?,pengkajian_fungsi_ket_kemampuan_menggenggam=?,pengkajian_fungsi_koordinasi=?,pengkajian_fungsi_ket_koordinasi=?,pengkajian_fungsi_gangguan_fungsi=?,riwayat_psiko_kondisipsiko=?,riwayat_psiko_adakah_prilaku=?,riwayat_psiko_ket_adakah_prilaku=?,riwayat_psiko_gangguan_jiwa=?,riwayat_psiko_hubungan_pasien=?,riwayat_psiko_tinggal_dengan=?,riwayat_psiko_ket_tinggal_dengan=?,riwayat_psiko_budaya=?,riwayat_psiko_ket_budaya=?,riwayat_psiko_pend_pj=?,riwayat_psiko_edukasi_pada=?,riwayat_psiko_ket_edukasi_pada=?,penilaian_nyeri=?,penilaian_nyeri_penyebab=?,penilaian_nyeri_ket_penyebab=?,penilaian_nyeri_kualitas=?,penilaian_nyeri_ket_kualitas=?,penilaian_nyeri_lokasi=?,penilaian_nyeri_menyebar=?,penilaian_nyeri_skala=?,penilaian_nyeri_waktu=?,penilaian_nyeri_hilang=?,penilaian_nyeri_ket_hilang=?,penilaian_nyeri_diberitahukan_dokter=?,penilaian_nyeri_jam_diberitahukan_dokter=?,penilaian_jatuh_skala1=?,penilaian_jatuh_nilai1=?,penilaian_jatuh_skala2=?,penilaian_jatuh_nilai2=?,penilaian_jatuh_skala3=?,penilaian_jatuh_nilai3=?,penilaian_jatuh_skala4=?,penilaian_jatuh_nilai4=?,penilaian_jatuh_skala5=?,penilaian_jatuh_nilai5=?,penilaian_jatuh_skala6=?,penilaian_jatuh_nilai6=?,penilaian_jatuh_totalnilai=?,skrining_gizi1=?,nilai_gizi1=?,skrining_gizi2=?,nilai_gizi2=?,nilai_total_gizi=?,skrining_gizi_diagnosa_khusus=?,skrining_gizi_ket_diagnosa_khusus=?,skrining_gizi_diketahui_dietisen=?,skrining_gizi_jam_diketahui_dietisen=?,kriteria1=?,kriteria2=?,kriteria3=?,kriteria4=?,pilihan1=?,"+
                "pilihan2=?,pilihan3=?,pilihan4=?,pilihan5=?,pilihan6=?,pilihan7=?,pilihan8=?,masalah=?,rencana=?,nip1=?,nip2=?,kd_dokter=?",177,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),Anamnesis.getSelectedItem().toString(),TibadiRuang.getSelectedItem().toString(),CaraMasuk.getSelectedItem().toString(),KeluhanUtama.getText(),RPK.getText(),PSK.getText(),RBedah.getText(),RPS.getText(),RObat.getText(),Alergi.getText(),KomplikasiKehamilan.getSelectedItem().toString(),KeteranganKomplikasiKehamilan.getText(),
                UmurMinarche.getText(),LamaMenstruasi.getText(),BanyaknyaPembalut.getText(),SiklusMenstruasi.getText(),KetSiklusMenstruasi.getSelectedItem().toString(),DirasakanMenstruasi.getSelectedItem().toString(),StatusMenikah.getSelectedItem().toString(),KaliMenikah.getText(),UsiaKawin1.getText(),StatusKawin1.getSelectedItem().toString(),UsiaKawin2.getText(),StatusKawin2.getSelectedItem().toString(),UsiaKawin3.getText(),
                StatusKawin3.getSelectedItem().toString(),G.getText(),P.getText(),A.getText(),Hidup.getText(),Valid.SetTgl(HPHT.getSelectedItem()+""),UsiaKehamilan.getText(),Valid.SetTgl(TP.getSelectedItem()+""),RiwayatImunisasi.getSelectedItem().toString(),ANC.getText(),ANCKe.getText(),RiwayatANC.getSelectedItem().toString(),KeluhanHamilMuda.getSelectedItem().toString(),KeluhanHamilTua.getSelectedItem().toString(),
                RiwayatKB.getSelectedItem().toString(),LamanyaKB.getText(),KomplikasiKB.getSelectedItem().toString(),KeteranganKomplikasiKB.getText(),BerhentiKB.getText(),AlasanBerhentiKB.getText(),RiwayatGenekologi.getSelectedItem().toString(),KebiasaanObat.getSelectedItem().toString(),KebiasaanObatDiminum.getText(),KebiasaanMerokok.getSelectedItem().toString(),KebiasaanJumlahRokok.getText(),KebiasaanAlkohol.getSelectedItem().toString(),
