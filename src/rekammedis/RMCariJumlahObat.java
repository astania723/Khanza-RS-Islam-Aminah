...
public class RMCariJumlahObat extends javax.swing.JDialog {
    ...
    private String[] tanggal,jam,jumlahobat;
    ...
    public void tampil() {
        ...
        for(i=0;i<tabMode.getRowCount();i++){
            if(tabMode.getValueAt(i,0).toString().equals("true")){
                ...
                jumlahobat[index]=tabMode.getValueAt(i,3).toString();
                index++;
            }
        }       
        ...
        for(i=0;i<jml;i++){
            tabMode.addRow(new Object[] {
                pilih[i],tanggal[i],jam[i],jumlahobat[i]
            });
        }
        Valid.tabelKosong(tabMode);
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "kodesatuan.satuan from detail_pemberian_obat inner join databarang on detail_pemberian_obat.kode_brng=databarang.kode_brng inner join kodesatuan on databarang.kode_sat=kodesatuan.kode_sat where "+
