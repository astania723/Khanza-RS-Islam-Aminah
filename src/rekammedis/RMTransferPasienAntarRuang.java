        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                try {
                    ...
                    while(rs.next()){
                        htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("tanggal_masuk")).append("</td><td valign='top'>").append(rs.getString("tanggal_pindah")).append("</td><td valign='top'>").append(rs.getString("indikasi_pindah_ruang")).append("</td><td valign='top'>").append(rs.getString("keterangan_indikasi_pindah_ruang")).append("</td><td valign='top'>").append(rs.getString("asal_ruang")).append("</td><td valign='top'>").append(rs.getString("ruang_selanjutnya")).append("</td><td valign='top'>").append(rs.getString("metode_pemindahan_pasien")).append("</td><td valign='top'>").append(rs.getString("diagnosa_utama")).append("</td><td valign='top'>").append(rs.getString("diagnosa_sekunder")).append("</td><td valign='top'>").append(rs.getString("prosedur_yang_sudah_dilakukan")).append("</td><td valign='top'>").append(rs.getString("obat_yang_telah_diberikan")).append("</td><td valign='top'>").append(rs.getString("pemeriksaan_penunjang_yang_dilakukan")).append("</td><td valign='top'>").append(rs.getString("peralatan_yang_menyertai")).append("</td><td valign='top'>").append(rs.getString("keterangan_peralatan_yang_menyertai")).append("</td><td valign='top'>").append(rs.getString("pasien_keluarga_menyetujui")).append("</td><td valign='top'>").append(rs.getString("nama_menyetujui")).append("</td><td valign='top'>").append(rs.getString("hubungan_menyetujui")).append("</td><td valign='top'>").append(rs.getString("keadaan_umum_sebelum_transfer")).append("</td><td valign='top'>").append(rs.getString("td_sebelum_transfer")).append("</td><td valign='top'>").append(rs.getString("nadi_sebelum_transfer")).append("</td><td valign='top'>").append(rs.getString("rr_sebelum_transfer")).append("</td><td valign='top'>").append(rs.getString("suhu_sebelum_transfer")).append("</td><td valign='top'>").append(rs.getString("keluhan_utama_sebelum_transfer")).append("</td><td valign='top'>").append(rs.getString("keadaan_umum_sesudah_transfer")).append("</td><td valign='top'>").append(rs.getString("td_sesudah_transfer")).append("</td><td valign='top'>").append(rs.getString("nadi_sesudah_transfer")).append("</td><td valign='top'>").append(rs.getString("rr_sesudah_transfer")).append("</td><td valign='top'>").append(rs.getString("suhu_sesudah_transfer")).append("</td><td valign='top'>").append(rs.getString("keluhan_utama_sesudah_transfer")).append("</td><td valign='top'>").append(rs.getString("nip_menyerahkan")).append("</td><td valign='top'>").append(rs.getString("petugasmenyerahkan")).append("</td><td valign='top'>").append(rs.getString("nip_menerima")).append("</td><td valign='top'>").append(rs.getString("petugasmenerima")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                        "<html>"+
