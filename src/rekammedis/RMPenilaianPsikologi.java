        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
			    ...
			    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='71px'><b>Rupa</b></td>"+
                    ...
                    while(rs.next()){
                        htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("nip")).append("</td><td valign='top'>").append(rs.getString("nama")).append("</td><td valign='top'>").append(rs.getString("tanggal")).append("</td><td valign='top'>").append(rs.getString("dikirim_dari")).append("</td><td valign='top'>").append(rs.getString("tujuan_pemeriksaan")).append("</td><td valign='top'>").append(rs.getString("anamnesis")).append("</td><td valign='top'>").append(rs.getString("ket_anamnesis")).append("</td><td valign='top'>").append(rs.getString("rupa")).append("</td><td valign='top'>").append(rs.getString("bentuk_tubuh")).append("</td><td valign='top'>").append(rs.getString("tindakan")).append("</td><td valign='top'>").append(rs.getString("pakaian")).append("</td><td valign='top'>").append(rs.getString("ekspresi")).append("</td><td valign='top'>").append(rs.getString("berbicara")).append("</td><td valign='top'>").append(rs.getString("penggunaan_kata")).append("</td><td valign='top'>").append(rs.getString("ciri_menyolok")).append("</td><td valign='top'>").append(rs.getString("hasil_psikotes")).append("</td><td valign='top'>").append(rs.getString("kepribadian")).append("</td><td valign='top'>").append(rs.getString("psikodinamika")).append("</td><td valign='top'>").append(rs.getString("kesimpulan_psikolog")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                        "<html>"+
