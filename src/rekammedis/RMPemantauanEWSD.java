...
public class RMPemantauanEWSD extends javax.swing.JDialog {
    ...
    */
    ...
    private void isjml(){
        if((!Skor1.getText().isEmpty())&&(!Skor2.getText().isEmpty())&&(!Skor3.getText().isEmpty())&&(!Skor4.getText().isEmpty())&&(!Skor5.getText().isEmpty())&&(!Skor6.getText().isEmpty())&&(!Skor7.getText().isEmpty())){
