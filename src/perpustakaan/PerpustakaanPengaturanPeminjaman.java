...
public class PerpustakaanPengaturanPeminjaman extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(MakBuku.getText().trim().isEmpty()||MakBuku.getText().trim().equals("0")){
            Valid.textKosong(MakBuku,"Maksimal Buku Dipinjam");
        }else if(Lama.getText().trim().isEmpty()||Lama.getText().trim().equals("0")){
            Valid.textKosong(Lama,"Maksimal Lama Peminjaman");
        }else if(Denda.getText().trim().isEmpty()||Denda.getText().trim().equals("0")){
