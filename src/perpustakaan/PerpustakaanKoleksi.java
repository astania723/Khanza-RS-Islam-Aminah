...
public class PerpustakaanKoleksi extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(KodePenerbit.getText().trim().isEmpty()||NamaPenerbit.getText().trim().isEmpty()){
            Valid.textKosong(KodePenerbit,"Penerbit");
        }else if(KodePengarang.getText().trim().isEmpty()||NamaPengarang.getText().trim().isEmpty()){
            Valid.textKosong(KodePengarang,"Pengarang");
        }else if(IdJenis.getText().trim().isEmpty()||nm_jenis.getText().trim().isEmpty()){
            Valid.textKosong(IdJenis,"Jenis");
        }else if(KodeKategori.getText().trim().isEmpty()||NamaKategori.getText().trim().isEmpty()){
