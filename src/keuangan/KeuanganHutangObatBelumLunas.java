                ...
                if(evt.getClickCount()==1){
                    if(tbBangsal.getSelectedColumn()==0){
                        if(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),11).toString().equals("0")){
                            tbBangsal.setValueAt(Double.valueOf(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),12).toString()), tbBangsal.getSelectedRow(),11);
                        }
                        if(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),0).toString().equals("true")){
                            ...
                            tbBangsal.setValueAt(Double.valueOf(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),12).toString()),tbBangsal.getSelectedRow(),10);
                        }
                        getData();
                    }
                    panggilPhoto();
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBayarActionPerformed
        ...
        }else if(nip.getText().trim().isEmpty()||nama_petugas.getText().trim().isEmpty()){
    ...
    private void ppSemuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSemuaActionPerformed
        for(row=0;row<tbBangsal.getRowCount();row++){
            ...
            if(tbBangsal.getValueAt(row,11).toString().equals("0")){
                tbBangsal.setValueAt(Double.valueOf(tbBangsal.getValueAt(row,12).toString()), row,11);
            }
            if(tbBangsal.getValueAt(row,0).toString().equals("true")){
                ...
                tbBangsal.setValueAt(Double.valueOf(tbBangsal.getValueAt(row,12).toString()),row,10);
            }
        }
        getData();
