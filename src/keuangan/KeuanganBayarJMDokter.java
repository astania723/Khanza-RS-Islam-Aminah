         ...
         try{         
            ...
            if(chkRalan.isSelected()==true){
                 ...
                 psrawatjalandr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_dr.tarif_tindakandr,"+
                     ...
                     "from bayar_jm_dokter inner join bayar_rawat_jl_dr on bayar_rawat_jl_dr.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                 ...
                 psrawatjalandrpr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_drpr.tarif_tindakandr,"+
                     ...
                     "from bayar_jm_dokter inner join bayar_rawat_jl_drpr on bayar_rawat_jl_drpr.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
            ...
            if(chkRanap.isSelected()==true){
                 ...
                 psrawatinapdr=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_rawat_inap_dr on bayar_rawat_inap_dr.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                 ...
                 psrawatinapdrpr=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_rawat_inap_drpr on bayar_rawat_inap_drpr.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
            ...
            if(chkOperasi.isSelected()==true){
                 psbiayaoperator1=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_operasi_operator1 on bayar_operasi_operator1.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                 ...
                 psbiayaoperator2=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_operasi_operator2 on bayar_operasi_operator2.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                     " and (pasien.nm_pasien like ? or paket_operasi.nm_perawatan like ? or reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or operasi.tgl_operasi like ?)")+
                     "order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                 psbiayaoperator3=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_operasi_operator3 on bayar_operasi_operator3.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                     " and (pasien.nm_pasien like ? or paket_operasi.nm_perawatan like ? or reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or operasi.tgl_operasi like ?)")+
                     "order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                 psbiayadokter_anak=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_operasi_dokter_anak on bayar_operasi_dokter_anak.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                     " and (pasien.nm_pasien like ? or paket_operasi.nm_perawatan like ? or reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or operasi.tgl_operasi like ?)")+
                     "order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                 psbiaya_dokter_umum=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_operasi_dokter_umum on bayar_operasi_dokter_umum.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                     " and (pasien.nm_pasien like ? or paket_operasi.nm_perawatan like ? or reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or operasi.tgl_operasi like ?)")+
                     "order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                 psbiaya_dokter_pjanak=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_operasi_dokter_pjanak on bayar_operasi_dokter_pjanak.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                     " and (pasien.nm_pasien like ? or paket_operasi.nm_perawatan like ? or reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or operasi.tgl_operasi like ?)")+
                     "order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                 psbiayadokter_anestesi=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_operasi_dokter_anestesi on bayar_operasi_dokter_anestesi.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                     " and (pasien.nm_pasien like ? or paket_operasi.nm_perawatan like ? or reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or operasi.tgl_operasi like ?)")+
                     "order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                 try {
            ...
            if(chkLaborat.isSelected()==true){
                ...
                psperiksa_lab=koneksi.prepareStatement(
                     ...
                     " from bayar_jm_dokter inner join bayar_periksa_lab on bayar_periksa_lab.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                 ...
                 psdetaillab=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_detail_periksa_lab on bayar_detail_periksa_lab.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                 ...
                 psperiksa_lab2=koneksi.prepareStatement(
                     ...
                     " from bayar_jm_dokter inner join bayar_periksa_lab_perujuk on bayar_periksa_lab_perujuk.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                     " and (pasien.nm_pasien like ? or  jns_perawatan_lab.nm_perawatan like ? or reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or periksa_lab.tgl_periksa like ?)")+
                     "order by periksa_lab.tgl_periksa,periksa_lab.jam,jns_perawatan_lab.nm_perawatan  ");            
                 try {
                 ...
                 psdetaillab2=koneksi.prepareStatement(
                     ...
                     "from bayar_jm_dokter inner join bayar_detail_periksa_lab_perujuk on bayar_detail_periksa_lab_perujuk.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                     " and (pasien.nm_pasien like ? or template_laboratorium.Pemeriksaan like ? or reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or periksa_lab.tgl_periksa like ?)")+
                     "order by periksa_lab.tgl_periksa,periksa_lab.jam");
                 try {
            ...
            if(chkRadiologi.isSelected()==true){
                //periksa radiologi
                 psperiksa_radiologi=koneksi.prepareStatement("select periksa_radiologi.tarif_tindakan_dokter,pasien.nm_pasien,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,periksa_radiologi.status,"+
                     ...
                     " from bayar_jm_dokter inner join bayar_periksa_radiologi on bayar_periksa_radiologi.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                 ...
                 psperiksa_radiologi2=koneksi.prepareStatement("select periksa_radiologi.tarif_perujuk,pasien.nm_pasien,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,periksa_radiologi.status,"+
                     ...
                     " from bayar_jm_dokter inner join bayar_periksa_radiologi_perujuk on bayar_periksa_radiologi_perujuk.no_bayar=bayar_jm_dokter.no_bayar) "+(TCari.getText().trim().isEmpty()?"":
                     " and (pasien.nm_pasien like ? or jns_perawatan_radiologi.nm_perawatan like ? or reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or periksa_radiologi.tgl_periksa like ?)")+
                     "order by periksa_radiologi.tgl_periksa,periksa_radiologi.jam,jns_perawatan_radiologi.nm_perawatan  ");            
                 try {
