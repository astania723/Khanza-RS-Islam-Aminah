    ...
    */
    ...
    private void tampil(){
        ...
        try{        
                        ...
                        while(rs.next()){                            
                            ...
                            if(CmbStatus.getSelectedItem().toString().equals("Semua")){
                                ...
                                if((petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim()))&&(rs.getString("nama_pasien").toLowerCase().trim().contains(TCari.getText().toLowerCase().trim())||nonota.toLowerCase().trim().contains(TCari.getText().toLowerCase().trim()))){
                                    ...
                                    htmlContent.append("<tr class='isi'><td valign='middle' align='center'>").append(no).append("</td><td valign='middle' align='center'>").append(rs.getString("tgl_bayar")).append("</td><td valign='middle' align='center'>").append(rsjamshift.getString("shift")).append("</td><td valign='middle' align='center'>").append(nonota).append("</td><td valign='middle' align='left'>").append(rs.getString("nama_pasien")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rs.getDouble("jumlah_bayar"))).append("</td><td valign='middle' align='left'>").append(petugas).append("</td>");
                                    for(i=0;i<kolom;i++){
                                        bayar=0;
            ...
            htmlContent.append("<tr class='isi'><td valign='middle' align='center'></td><td valign='middle' align='right'>Total :</td><td valign='middle' align='center'></td><td valign='middle' align='center'></td><td valign='middle' align='left'></td><td valign='middle' align='right'>").append(Valid.SetAngka(all)).append("</td><td valign='middle' align='left'></td>");
            for(i=0;i<kolom;i++){
    ...
    private void tampil2(){
        ...
        try{        
            ...
            htmlContent.append("<tr class='isi'><td valign='middle' align='center'></td><td valign='middle' align='right'>Total :</td><td valign='middle' align='center'></td><td valign='middle' align='center'></td><td valign='middle' align='left'></td><td valign='middle' align='right'>").append(Math.round(all)).append("</td><td valign='middle' align='left'></td>");
            for(i=0;i<kolom;i++){
