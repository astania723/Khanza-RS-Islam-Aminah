            ...
            switch (pilihan) {
                case "Laporan 1 (HTML)":
                        ...
                        for(i=0;i<tabMode.getRowCount();i++){  
                            ...
                            htmlContent.append("<tr class='isi'><td valign='top'>").append(tabMode.getValueAt(i,0).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,1).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,2).toString().replaceAll("'","`")).append("</td><td valign='top' align='center'>").append(tabMode.getValueAt(i,3).toString().replaceAll("'","`")).append("</td><td valign='top' align='center'>").append(tabMode.getValueAt(i,4).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,5).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,6).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,7).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,8).toString().replaceAll("'","`")).append("</td><td valign='top' align='center'>").append(tabMode.getValueAt(i,9).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,10).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,11).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,12).toString().replaceAll("'","`")).append("</td><td valign='top'>").append(tabMode.getValueAt(i,13).toString().replaceAll("'","`")).append("</td><td valign='top' align='center'>").append(tabMode.getValueAt(i,14).toString().replaceAll("'","`")).append("</td><td valign='top' align='right'>").append(js).append("</td><td valign='top' align='right'>").append(jm).append("</td><td valign='top' align='right'>").append(tarif).append("</td><td valign='top' align='right'>").append(totalsaranas).append("</td><td valign='top' align='right'>").append(totaljms).append("</td><td valign='top' align='right'>").append(totalbayars).append("</td><td valign='top' align='center'>").append(tabMode.getValueAt(i,21).toString().replaceAll("'","`")).append("</td></tr>"); 
                        }            
                ...
                case "Laporan 5 (CSV)":
                        ...
                        for(i=0;i<tabMode.getRowCount();i++){  
                            ...
                            htmlContent.append("\"").append(tabMode.getValueAt(i,0).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,1).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,2).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,3).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,4).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,5).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,6).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,7).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,8).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,9).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,10).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,11).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,12).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,13).toString().replaceAll("'","`")).append("\";\"").append(tabMode.getValueAt(i,14).toString().replaceAll("'","`")).append("\";\"").append(js).append("\";\"").append(jm).append("\";\"").append(tarif).append("\";\"").append(totalsaranas).append("\";\"").append(totaljms).append("\";\"").append(totalbayars).append("\";\"").append(tabMode.getValueAt(i,21).toString().replaceAll("'","`")).append("\"\n"); 
                        }            
            ...
            try {
                ...
                while(rsreg.next()){
                    ...
                    if(rsreg.getString("status_lanjut").equals("Ralan")){
                        ...
                        dpjp=Sequel.cariIsi("select nm_dokter from dpjp_ranap inner join dokter on dpjp_ranap.kd_dokter = dokter.kd_dokter where dpjp_ranap.no_rawat=?",rsreg.getString("no_rawat"));
                        if(dpjp.isEmpty()){
                            dpjp=rsreg.getString("nm_dokter");
                        }
                        diagnosa="";
                        ...
                        try {
                            ...
                            while(rstindakan.next()){
                                ...
                                tabMode.addRow(new Object[]{
                                    ...
                                    dpjp,kddiagnosa,diagnosa,
                                    rsreg.getString("kd_pj"),rsreg.getString("png_jawab"),
                                    "Farmasi",namaruangan,rstindakan.getString("nama_brng"),
                        ...
                        try {
                            ...
                            while(rstindakan.next()){
                                ...
                                tabMode.addRow(new Object[]{
                                    ...
                                    dpjp,kddiagnosa,diagnosa,
                                    rsreg.getString("kd_pj"),rsreg.getString("png_jawab"),
                                    "Kamar",namaruangan,rstindakan.getString("nm_bangsal"),
