...
public class DlgKamar extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if((TCari.getText().trim().isEmpty())&&(panelCari.isVisible()==false)){
            ...
            }else if((! TCari.getText().trim().isEmpty())&&(panelCari.isVisible()==false)){
                ...
                Valid.MyReportqry("rptKamar.jasper","report","::[ Data Nomor Kamar ]::","select kd_kamar,kamar.kd_bangsal,bangsal.nm_bangsal, "+
                               ...
                               "order by kd_kamar ",param);
            }else if((TCari.getText().trim().isEmpty())&&(panelCari.isVisible()==true)&&(CmbCrIsi.getItemCount()>0)){
                String key="and kamar.statusdata='1'";
                if(BangsalCari.getText().isEmpty()&&CmbCrIsi.getSelectedItem().toString().equals(" ")){
                     key="and kamar.statusdata='1'";
                }else if((! BangsalCari.getText().isEmpty())&&CmbCrIsi.getSelectedItem().toString().equals(" ")){
