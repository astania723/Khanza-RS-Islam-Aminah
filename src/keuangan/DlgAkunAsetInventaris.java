...
public class DlgAkunAsetInventaris extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdjenis.getText().trim().isEmpty()||nmjenis.getText().trim().isEmpty()){
            Valid.textKosong(kdjenis,"Jenis Inventaris");
        }else if(kdrek.getText().trim().isEmpty()||nmrek.getText().trim().isEmpty()){
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "inner join inventaris_jenis on akun_aset_inventaris.id_jenis=inventaris_jenis.id_jenis "+(TCari.getText().trim().isEmpty()?
