...
public class DlgRBObatPercaraBayar extends javax.swing.JDialog {
    ...
    public DlgRBObatPercaraBayar(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.","Cara Bayar","Tanggal","Nama Obat","Jml","Biaya Obat","Sub Total Obat","Embalase","Tuslah","Total Biaya","Hrg.Beli","Total Hrg.Beli","Keuntungan"};
           ...
           while(rspenjab.next()){
               ...
               while(rsresep.next()){
                   ...
                   tabMode.addRow(new Object[]{
                       ...
                       rsresep.getDouble("jml"),rsresep.getDouble("biaya_obat"),rsresep.getDouble("subtotal"),rsresep.getDouble("embalase"),rsresep.getDouble("tuslah"),rsresep.getDouble("total"),rsresep.getDouble("h_beli"),
                       rsresep.getDouble("total_asal"),rsresep.getDouble("keuntungan")
                   });
                   a++;
               }
               if(subtotal>0){
                   tabMode.addRow(new Object[]{"","       "+"Subtotal ",":","",null,biaya,embalase,tuslah,subtotal,ttotal,hrgbeli,subhargabeli,keuntungan});
               }  
               i++;
           }
           tabMode.addRow(new Object[]{">>","Total ",":","",null,ttlbiaya,ttembalase,tttuslah,ttsubtotal,tttotal,tthrgbeli,ttsubhrgbeli,ttkeuntungan});
           this.setCursor(Cursor.getDefaultCursor());             
        }catch(Exception e){
