    ...
    */
        ...
        try{
            ...
            if(chkRalan.isSelected()==true){
                ps=koneksi.prepareStatement(
                        ...
                        (NmCaraBayar.getText().trim().isEmpty()?"":" and reg_periksa.kd_pj='"+KdCaraBayar.getText()+"' ")+
                ...
                try {
                    ...
                    rs=ps.executeQuery();
                    while(rs.next()){
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='10'>@ ").append(rs.getString("nm_poli").toUpperCase()).append("</td></tr>");
                        ...
                        try {
                            ...
                            while(rs2.next()){
                                ...
                                jasamedis=Sequel.cariIsiAngka("select sum(rawat_jl_dr.tarif_tindakandr) from rawat_jl_dr where rawat_jl_dr.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and rawat_jl_dr.kd_dokter='"+KdDokter.getText()+"' "),rs2.getString("no_rawat"))+
                                          Sequel.cariIsiAngka("select sum(rawat_jl_pr.tarif_tindakanpr) from rawat_jl_pr where rawat_jl_pr.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and rawat_jl_pr.nip='"+KdDokter.getText()+"' "),rs2.getString("no_rawat"))+
                                          Sequel.cariIsiAngka("select sum(rawat_jl_drpr.tarif_tindakandr) from rawat_jl_drpr where rawat_jl_drpr.no_rawat=?"+(NmDokter.getText().trim().isEmpty()?"":" and rawat_jl_drpr.kd_dokter='"+KdDokter.getText()+"' "),rs2.getString("no_rawat"))+
                                          Sequel.cariIsiAngka("select sum(rawat_jl_drpr.tarif_tindakanpr) from rawat_jl_drpr where rawat_jl_drpr.no_rawat=?"+(NmDokter.getText().trim().isEmpty()?"":" and rawat_jl_drpr.nip='"+KdDokter.getText()+"' "),rs2.getString("no_rawat"));
                                ...
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(rs2.getString("no_rawat")).append("</td><td valign='middle' align='left'>").append(rs2.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rs2.getString("nm_pasien")).append("</td><td valign='middle' align='center'>").append(rs2.getString("tgl_registrasi")).append("</td><td valign='middle' align='center'>").append(rs2.getString("tgl_registrasi")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(jasasarana)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(jasamedis)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(jasamenejemen)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(bhp)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(total)).append("</td></tr>");
                            }
                            rs2.last();
                            if(rs2.getRow()>0){
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='5'>SUBTOTAL</td><td valign='middle' align='right'>").append(Valid.SetAngka(subjasasarana)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subjasamedis)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subjasamenejemen)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subbhp)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subtotal)).append("</td></tr><tr class='isi'><td valign='middle' align='left' colspan='10'>&nbsp;</td></tr>");
                            }
                        }catch (Exception e) {
                            System.out.println("Notifikasi : "+e);
                        }finally{
            ...
            if(chkRanap.isSelected()==true){
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        jasamedis=Sequel.cariIsiAngka("select sum(rawat_inap_dr.tarif_tindakandr) from rawat_inap_dr where rawat_inap_dr.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and rawat_inap_dr.kd_dokter='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(rawat_inap_pr.tarif_tindakanpr) from rawat_inap_pr where rawat_inap_pr.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and rawat_inap_pr.nip='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(rawat_inap_drpr.tarif_tindakandr) from rawat_inap_drpr where rawat_inap_drpr.no_rawat=?"+(NmDokter.getText().trim().isEmpty()?"":" and rawat_inap_drpr.kd_dokter='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(rawat_inap_drpr.tarif_tindakanpr) from rawat_inap_drpr where rawat_inap_drpr.no_rawat=?"+(NmDokter.getText().trim().isEmpty()?"":" and rawat_inap_drpr.nip='"+KdDokter.getText()+"' "),rs.getString("no_rawat"));
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(rs.getString("no_rawat")).append("</td><td valign='middle' align='left'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rs.getString("nm_pasien")).append("</td><td valign='middle' align='center'>").append(rs.getString("tgl_registrasi")).append("</td><td valign='middle' align='center'>").append(Sequel.cariIsi("select if(kamar_inap.tgl_keluar='0000-00-00','Belum Pulang',kamar_inap.tgl_keluar) from kamar_inap where kamar_inap.no_rawat=? order by kamar_inap.tgl_keluar desc limit 1 ",rs.getString("no_rawat"))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(jasasarana)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(jasamedis)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(jasamenejemen)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(bhp)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(total)).append("</td></tr>");
                    }
                    rs.last();
                    if(rs.getRow()>0){
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='5'>SUBTOTAL</td><td valign='middle' align='right'>").append(Valid.SetAngka(subjasasarana)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subjasamedis)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subjasamenejemen)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subbhp)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subtotal)).append("</td></tr><tr class='isi'><td valign='middle' align='left' colspan='10'>&nbsp;</td></tr>");
            ...
            if(chkOperasi.isSelected()==true){
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        jasamedis=Sequel.cariIsiAngka("select sum(operasi.biayaoperator1) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.operator1='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayaoperator2) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.operator2='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayaoperator3) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.operator3='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayadokter_anak) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.dokter_anak='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biaya_dokter_umum) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.dokter_umum='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biaya_dokter_pjanak) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.dokter_pjanak='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayadokter_anestesi) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.dokter_anestesi='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayaasisten_operator1) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.asisten_operator1='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayaasisten_operator2) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.asisten_operator2='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayaasisten_operator3) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.asisten_operator3='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayainstrumen) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.instrumen='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayaperawaat_resusitas) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.perawaat_resusitas='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayaasisten_anestesi) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.asisten_anestesi='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayaasisten_anestesi2) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.asisten_anestesi2='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayabidan) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.bidan='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayabidan2) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.bidan2='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayabidan3) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.bidan3='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biayaperawat_luar) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.perawat_luar='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biaya_omloop) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.omloop='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biaya_omloop2) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.omloop2='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biaya_omloop3) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.omloop3='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biaya_omloop4) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.omloop4='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(operasi.biaya_omloop5) from operasi where operasi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and operasi.omloop5='"+KdDokter.getText()+"' "),rs.getString("no_rawat"));
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(rs.getString("no_rawat")).append("</td><td valign='middle' align='left'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rs.getString("nm_pasien")).append("</td><td valign='middle' align='center'>").append(rs.getString("tgl_registrasi")).append("</td><td valign='middle' align='center'>").append(rs.getString("status_lanjut").equals("Ralan")?rs.getString("tgl_registrasi"):Sequel.cariIsi("select if(kamar_inap.tgl_keluar='0000-00-00','Belum Pulang',kamar_inap.tgl_keluar) from kamar_inap where kamar_inap.no_rawat=? order by kamar_inap.tgl_keluar desc limit 1 ",rs.getString("no_rawat"))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(jasasarana)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(jasamedis)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(jasamenejemen)).append("</td><td valign='middle' align='right'>0</td><td valign='middle' align='right'>").append(Valid.SetAngka(total)).append("</td></tr>");
                    }
                    rs.last();
                    if(rs.getRow()>0){
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='5'>SUBTOTAL</td><td valign='middle' align='right'>").append(Valid.SetAngka(subjasasarana)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subjasamedis)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subjasamenejemen)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subbhp)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(subtotal)).append("</td></tr><tr class='isi'><td valign='middle' align='left' colspan='10'>&nbsp;</td></tr>");
            ...
            if(chkLaborat.isSelected()==true){
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        jasamedis=Sequel.cariIsiAngka("select sum(periksa_lab.tarif_tindakan_dokter) from periksa_lab where periksa_lab.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and periksa_lab.kd_dokter='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(periksa_lab.tarif_perujuk) from periksa_lab where periksa_lab.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and periksa_lab.dokter_perujuk='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(periksa_lab.tarif_tindakan_petugas) from periksa_lab where periksa_lab.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and periksa_lab.nip='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(detail_periksa_lab.bagian_dokter) from detail_periksa_lab inner join periksa_lab "+
                                                      ...
                                                      "where detail_periksa_lab.no_rawat=?"+(NmDokter.getText().trim().isEmpty()?"":" and periksa_lab.kd_dokter='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(detail_periksa_lab.bagian_perujuk) from detail_periksa_lab inner join periksa_lab "+
                                                      "on periksa_lab.no_rawat=detail_periksa_lab.no_rawat and periksa_lab.kd_jenis_prw=detail_periksa_lab.kd_jenis_prw "+
                                                      "and periksa_lab.tgl_periksa=detail_periksa_lab.tgl_periksa and periksa_lab.jam=detail_periksa_lab.jam "+
                                                      " where detail_periksa_lab.no_rawat=?"+(NmDokter.getText().trim().isEmpty()?"":" and periksa_lab.dokter_perujuk='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(detail_periksa_lab.bagian_laborat) from detail_periksa_lab inner join periksa_lab "+
                                                      "on periksa_lab.no_rawat=detail_periksa_lab.no_rawat and periksa_lab.kd_jenis_prw=detail_periksa_lab.kd_jenis_prw "+
                                                      "and periksa_lab.tgl_periksa=detail_periksa_lab.tgl_periksa and periksa_lab.jam=detail_periksa_lab.jam "+
                                                      " where detail_periksa_lab.no_rawat=?"+(NmDokter.getText().trim().isEmpty()?"":" and periksa_lab.nip='"+KdDokter.getText()+"' "),rs.getString("no_rawat"));
            ...
            if(chkRadiologi.isSelected()==true){
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        jasamedis=Sequel.cariIsiAngka("select sum(periksa_radiologi.tarif_tindakan_dokter) from periksa_radiologi where periksa_radiologi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and periksa_radiologi.kd_dokter='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(periksa_radiologi.tarif_perujuk) from periksa_radiologi where periksa_radiologi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and periksa_radiologi.dokter_perujuk='"+KdDokter.getText()+"' "),rs.getString("no_rawat"))+
                                  Sequel.cariIsiAngka("select sum(periksa_radiologi.tarif_tindakan_petugas) from periksa_radiologi where periksa_radiologi.no_rawat=? "+(NmDokter.getText().trim().isEmpty()?"":" and periksa_radiologi.nip='"+KdDokter.getText()+"' "),rs.getString("no_rawat"));
            ...
            if(ttltotal>0){
                htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='5'>JUMLAH TOTAL</td><td valign='middle' align='right'>").append(Valid.SetAngka(ttljasasarana)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(ttljasamedis)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(ttljasamenejemen)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(ttlbhp)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(ttltotal)).append("</td></tr>");
            }
    ...
    private void prosesCariSemua2() {
        try{
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            while(rs2.next()){
                                ...
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(rs2.getString("no_rawat")).append("</td><td valign='middle' align='left'>").append(rs2.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rs2.getString("nm_pasien")).append("</td><td valign='middle' align='center'>").append(rs2.getString("tgl_registrasi")).append("</td><td valign='middle' align='center'>").append(rs2.getString("tgl_registrasi")).append("</td><td valign='middle' align='right'>").append(Math.round(jasasarana)).append("</td><td valign='middle' align='right'>").append(Math.round(jasamedis)).append("</td><td valign='middle' align='right'>").append(Math.round(jasamenejemen)).append("</td><td valign='middle' align='right'>").append(Math.round(bhp)).append("</td><td valign='middle' align='right'>").append(Math.round(total)).append("</td></tr>");
                            }
                            rs2.last();
                            if(rs2.getRow()>0){
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='5'>SUBTOTAL</td><td valign='middle' align='right'>").append(Math.round(subjasasarana)).append("</td><td valign='middle' align='right'>").append(Math.round(subjasamedis)).append("</td><td valign='middle' align='right'>").append(Math.round(subjasamenejemen)).append("</td><td valign='middle' align='right'>").append(Math.round(subbhp)).append("</td><td valign='middle' align='right'>").append(Math.round(subtotal)).append("</td></tr><tr class='isi'><td valign='middle' align='left' colspan='10'>&nbsp;</td></tr>");
                            }
                        }catch (Exception e) {
                            System.out.println("Notifikasi : "+e);
                        }finally{
            ...
            if(chkRanap.isSelected()==true){
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(rs.getString("no_rawat")).append("</td><td valign='middle' align='left'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rs.getString("nm_pasien")).append("</td><td valign='middle' align='center'>").append(rs.getString("tgl_registrasi")).append("</td><td valign='middle' align='center'>").append(Sequel.cariIsi("select if(kamar_inap.tgl_keluar='0000-00-00','Belum Pulang',kamar_inap.tgl_keluar) from kamar_inap where kamar_inap.no_rawat=? order by kamar_inap.tgl_keluar desc limit 1 ",rs.getString("no_rawat"))).append("</td><td valign='middle' align='right'>").append(Math.round(jasasarana)).append("</td><td valign='middle' align='right'>").append(Math.round(jasamedis)).append("</td><td valign='middle' align='right'>").append(Math.round(jasamenejemen)).append("</td><td valign='middle' align='right'>").append(Math.round(bhp)).append("</td><td valign='middle' align='right'>").append(Math.round(total)).append("</td></tr>");
                    }
                    rs.last();
                    if(rs.getRow()>0){
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='5'>SUBTOTAL</td><td valign='middle' align='right'>").append(Math.round(subjasasarana)).append("</td><td valign='middle' align='right'>").append(Math.round(subjasamedis)).append("</td><td valign='middle' align='right'>").append(Math.round(subjasamenejemen)).append("</td><td valign='middle' align='right'>").append(Math.round(subbhp)).append("</td><td valign='middle' align='right'>").append(Math.round(subtotal)).append("</td></tr><tr class='isi'><td valign='middle' align='left' colspan='10'>&nbsp;</td></tr>");
            ...
            if(chkOperasi.isSelected()==true){
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(rs.getString("no_rawat")).append("</td><td valign='middle' align='left'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rs.getString("nm_pasien")).append("</td><td valign='middle' align='center'>").append(rs.getString("tgl_registrasi")).append("</td><td valign='middle' align='center'>").append(rs.getString("status_lanjut").equals("Ralan")?rs.getString("tgl_registrasi"):Sequel.cariIsi("select if(kamar_inap.tgl_keluar='0000-00-00','Belum Pulang',kamar_inap.tgl_keluar) from kamar_inap where kamar_inap.no_rawat=? order by kamar_inap.tgl_keluar desc limit 1 ",rs.getString("no_rawat"))).append("</td><td valign='middle' align='right'>").append(Math.round(jasasarana)).append("</td><td valign='middle' align='right'>").append(Math.round(jasamedis)).append("</td><td valign='middle' align='right'>").append(Math.round(jasamenejemen)).append("</td><td valign='middle' align='right'>0</td><td valign='middle' align='right'>").append(Math.round(total)).append("</td></tr>");
                    }
                    rs.last();
                    if(rs.getRow()>0){
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='5'>SUBTOTAL</td><td valign='middle' align='right'>").append(Math.round(subjasasarana)).append("</td><td valign='middle' align='right'>").append(Math.round(subjasamedis)).append("</td><td valign='middle' align='right'>").append(Math.round(subjasamenejemen)).append("</td><td valign='middle' align='right'>").append(Math.round(subbhp)).append("</td><td valign='middle' align='right'>").append(Math.round(subtotal)).append("</td></tr><tr class='isi'><td valign='middle' align='left' colspan='10'>&nbsp;</td></tr>");
            ...
            if(ttltotal>0){
                htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='5'>JUMLAH TOTAL</td><td valign='middle' align='right'>").append(Math.round(ttljasasarana)).append("</td><td valign='middle' align='right'>").append(Math.round(ttljasamedis)).append("</td><td valign='middle' align='right'>").append(Math.round(ttljasamenejemen)).append("</td><td valign='middle' align='right'>").append(Math.round(ttlbhp)).append("</td><td valign='middle' align='right'>").append(Math.round(ttltotal)).append("</td></tr>");
            }
