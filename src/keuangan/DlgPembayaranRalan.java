...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    */
    ...
    public void tampil(){
        ...
        try{      
            if(NmPoli.getText().isEmpty()&&NmCaraBayar.getText().isEmpty()&&NmDokter.getText().isEmpty()&&TCari.getText().isEmpty()){
