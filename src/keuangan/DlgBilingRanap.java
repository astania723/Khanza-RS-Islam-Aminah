...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnSimpanUbahLamaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanUbahLamaActionPerformed
        if(norawatubahlama.getText().trim().isEmpty()||(tbUbahLama.getRowCount()<=0)){
                    ...
                    try {
                        ...
                        if(rsanak.next()){
                            ...
                            try{
                                ...
                                rscaripasien=pscaripasien.executeQuery();
                                if(rscaripasien.next()){
                                    tabModeRwJlDr.addRow(new Object[]{true,"Nama Pasien",": "+TPasien.getText()+", "+rscaripasien.getString("tgl_lahir")+", ("+rsreg.getString("umurdaftar")+rsreg.getString("sttsumur")+")","",null,null,null,null,"-"});
                                    tgl_lahir=rscaripasien.getString(3);
                                }
                            }catch (Exception e){
                                tabModeRwJlDr.addRow(new Object[]{true,"Nama Pasien",": ","",null,null,null,null,"-"});
                                tgl_lahir="";
                            }finally{
                                if(rscaripasien != null){
                                    rscaripasien.close();
