...
public class DlgPengaturanRekening extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TabRawat.getSelectedIndex()==0){
            ...
            if(Pengadaan_Obat.isEmpty()||Pemesanan_Obat.isEmpty()||Kontra_Pemesanan_Obat.isEmpty()||Bayar_Pemesanan_Obat.isEmpty()||Penjualan_Obat.isEmpty()||
                    Piutang_Obat.isEmpty()||Kontra_Piutang_Obat.isEmpty()||Retur_Ke_Suplayer.isEmpty()||Kontra_Retur_Ke_Suplayer.isEmpty()||
                    Retur_Dari_pembeli.isEmpty()||Kontra_Retur_Dari_Pembeli.isEmpty()||Retur_Piutang_Obat.isEmpty()||Kontra_Retur_Piutang_Obat.isEmpty()||
                    Pengadaan_Ipsrs.isEmpty()||Stok_Keluar_Ipsrs.isEmpty()||Kontra_Stok_Keluar_Ipsrs.isEmpty()||Bayar_Piutang_Pasien.isEmpty()||
                    Pengambilan_Utd.isEmpty()||Kontra_Pengambilan_Utd.isEmpty()||Pengambilan_Penunjang_Utd.isEmpty()||
                    Kontra_Pengambilan_Penunjang_Utd.isEmpty()||Penyerahan_Darah.isEmpty()||Stok_Keluar_Medis.isEmpty()||Kontra_Stok_Keluar_Medis.isEmpty()||
                    HPP_Obat_Jual_Bebas.isEmpty()||Persediaan_Obat_Jual_Bebas.isEmpty()||Penerimaan_NonMedis.isEmpty()||Kontra_Penerimaan_NonMedis.isEmpty()||
                    Bayar_Pemesanan_Non_Medis.isEmpty()||Hibah_Obat.isEmpty()||Kontra_Hibah_Obat.isEmpty()||Penerimaan_Toko.isEmpty()||Kontra_Penerimaan_Toko.isEmpty()||
                    Pengadaan_Toko.isEmpty()||Bayar_Pemesanan_Toko.isEmpty()||Penjualan_Toko.isEmpty()||HPP_Barang_Toko.isEmpty()||Persediaan_Barang_Toko.isEmpty()||
                    Piutang_Toko.isEmpty()||Kontra_Piutang_Toko.isEmpty()||Retur_Beli_Toko.isEmpty()||Kontra_Retur_Beli_Toko.isEmpty()||Retur_Beli_Non_Medis.isEmpty()||
                    Kontra_Retur_Beli_Non_Medis.isEmpty()||Retur_Jual_Toko.isEmpty()||Kontra_Retur_Jual_Toko.isEmpty()||Retur_Piutang_Toko.isEmpty()||
                    Kontra_Retur_Piutang_Toko.isEmpty()||Suspen_Piutang_Tindakan_Ralan.isEmpty()||Tindakan_Ralan.isEmpty()||Beban_Jasa_Medik_Dokter_Tindakan_Ralan.isEmpty()||
                    Utang_Jasa_Medik_Dokter_Tindakan_Ralan.isEmpty()||Beban_Jasa_Medik_Paramedis_Tindakan_Ralan.isEmpty()||Utang_Jasa_Medik_Paramedis_Tindakan_Ralan.isEmpty()||
                    Beban_KSO_Tindakan_Ralan.isEmpty()||Utang_KSO_Tindakan_Ralan.isEmpty()||Beban_Jasa_Sarana_Tindakan_Ralan.isEmpty()||Utang_Jasa_Sarana_Tindakan_Ralan.isEmpty()||
                    HPP_BHP_Tindakan_Ralan.isEmpty()||Persediaan_BHP_Tindakan_Ralan.isEmpty()||Beban_Jasa_Menejemen_Tindakan_Ralan.isEmpty()||
                    Utang_Jasa_Menejemen_Tindakan_Ralan.isEmpty()||Suspen_Piutang_Laborat_Ralan.isEmpty()||Laborat_Ralan.isEmpty()||
                    Beban_Jasa_Medik_Dokter_Laborat_Ralan.isEmpty()||Utang_Jasa_Medik_Dokter_Laborat_Ralan.isEmpty()||Beban_Jasa_Medik_Petugas_Laborat_Ralan.isEmpty()||
                    Utang_Jasa_Medik_Petugas_Laborat_Ralan.isEmpty()||Beban_Kso_Laborat_Ralan.isEmpty()||Utang_Kso_Laborat_Ralan.isEmpty()||
                    HPP_Persediaan_Laborat_Rawat_Jalan.isEmpty()||Persediaan_BHP_Laborat_Rawat_Jalan.isEmpty()||Beban_Jasa_Sarana_Laborat_Ralan.isEmpty()||
                    Utang_Jasa_Sarana_Laborat_Ralan.isEmpty()||Beban_Jasa_Perujuk_Laborat_Ralan.isEmpty()||Utang_Jasa_Perujuk_Laborat_Ralan.isEmpty()||
                    Beban_Jasa_Menejemen_Laborat_Ralan.isEmpty()||Utang_Jasa_Menejemen_Laborat_Ralan.isEmpty()||Suspen_Piutang_Radiologi_Ralan.isEmpty()||
                    Radiologi_Ralan.isEmpty()||Beban_Jasa_Medik_Dokter_Radiologi_Ralan.isEmpty()||Utang_Jasa_Medik_Dokter_Radiologi_Ralan.isEmpty()||
                    Beban_Jasa_Medik_Petugas_Radiologi_Ralan.isEmpty()||Utang_Jasa_Medik_Petugas_Radiologi_Ralan.isEmpty()||Beban_Kso_Radiologi_Ralan.isEmpty()||
                    Utang_Kso_Radiologi_Ralan.isEmpty()||HPP_Persediaan_Radiologi_Rawat_Jalan.isEmpty()||Persediaan_BHP_Radiologi_Rawat_Jalan.isEmpty()||
                    Beban_Jasa_Sarana_Radiologi_Ralan.isEmpty()||Utang_Jasa_Sarana_Radiologi_Ralan.isEmpty()||Beban_Jasa_Perujuk_Radiologi_Ralan.isEmpty()||
                    Utang_Jasa_Perujuk_Radiologi_Ralan.isEmpty()||Beban_Jasa_Menejemen_Radiologi_Ralan.isEmpty()||Utang_Jasa_Menejemen_Radiologi_Ralan.isEmpty()||
                    Suspen_Piutang_Obat_Ralan.isEmpty()||Obat_Ralan.isEmpty()||HPP_Obat_Rawat_Jalan.isEmpty()||Persediaan_Obat_Rawat_Jalan.isEmpty()||
                    Registrasi_Ralan.isEmpty()||Suspen_Piutang_Operasi_Ralan.isEmpty()||Operasi_Ralan.isEmpty()||Beban_Jasa_Medik_Dokter_Operasi_Ralan.isEmpty()||
                    Utang_Jasa_Medik_Dokter_Operasi_Ralan.isEmpty()||Beban_Jasa_Medik_Paramedis_Operasi_Ralan.isEmpty()||Utang_Jasa_Medik_Paramedis_Operasi_Ralan.isEmpty()||
                    HPP_Obat_Operasi_Ralan.isEmpty()||Persediaan_Obat_Kamar_Operasi_Ralan.isEmpty()||Tambahan_Ralan.isEmpty()||Potongan_Ralan.isEmpty()||
                    Suspen_Piutang_Tindakan_Ranap.isEmpty()||Tindakan_Ranap.isEmpty()||Beban_Jasa_Medik_Dokter_Tindakan_Ranap.isEmpty()||
                    Utang_Jasa_Medik_Dokter_Tindakan_Ranap.isEmpty()||Beban_Jasa_Medik_Paramedis_Tindakan_Ranap.isEmpty()||Utang_Jasa_Medik_Paramedis_Tindakan_Ranap.isEmpty()||
                    Beban_KSO_Tindakan_Ranap.isEmpty()||Utang_KSO_Tindakan_Ranap.isEmpty()||Beban_Jasa_Sarana_Tindakan_Ranap.isEmpty()||
                    Utang_Jasa_Sarana_Tindakan_Ranap.isEmpty()||Beban_Jasa_Menejemen_Tindakan_Ranap.isEmpty()||Utang_Jasa_Menejemen_Tindakan_Ranap.isEmpty()||
                    HPP_BHP_Tindakan_Ranap.isEmpty()||Persediaan_BHP_Tindakan_Ranap.isEmpty()||Suspen_Piutang_Laborat_Ranap.isEmpty()||Laborat_Ranap.isEmpty()||
                    Beban_Jasa_Medik_Dokter_Laborat_Ranap.isEmpty()||Utang_Jasa_Medik_Dokter_Laborat_Ranap.isEmpty()||Beban_Jasa_Medik_Petugas_Laborat_Ranap.isEmpty()||
                    Utang_Jasa_Medik_Petugas_Laborat_Ranap.isEmpty()||Beban_Kso_Laborat_Ranap.isEmpty()||Utang_Kso_Laborat_Ranap.isEmpty()||
                    HPP_Persediaan_Laborat_Rawat_inap.isEmpty()||Persediaan_BHP_Laborat_Rawat_Inap.isEmpty()||Beban_Jasa_Sarana_Laborat_Ranap.isEmpty()||
                    Utang_Jasa_Sarana_Laborat_Ranap.isEmpty()||Beban_Jasa_Perujuk_Laborat_Ranap.isEmpty()||Utang_Jasa_Perujuk_Laborat_Ranap.isEmpty()||
                    Beban_Jasa_Menejemen_Laborat_Ranap.isEmpty()||Utang_Jasa_Menejemen_Laborat_Ranap.isEmpty()||Suspen_Piutang_Radiologi_Ranap.isEmpty()||
                    Radiologi_Ranap.isEmpty()||Beban_Jasa_Medik_Dokter_Radiologi_Ranap.isEmpty()||Utang_Jasa_Medik_Dokter_Radiologi_Ranap.isEmpty()||
                    Beban_Jasa_Medik_Petugas_Radiologi_Ranap.isEmpty()||Utang_Jasa_Medik_Petugas_Radiologi_Ranap.isEmpty()||Beban_Kso_Radiologi_Ranap.isEmpty()||
                    Utang_Kso_Radiologi_Ranap.isEmpty()||HPP_Persediaan_Radiologi_Rawat_Inap.isEmpty()||Persediaan_BHP_Radiologi_Rawat_Inap.isEmpty()||
                    Beban_Jasa_Sarana_Radiologi_Ranap.isEmpty()||Utang_Jasa_Sarana_Radiologi_Ranap.isEmpty()||Beban_Jasa_Perujuk_Radiologi_Ranap.isEmpty()||
                    Utang_Jasa_Perujuk_Radiologi_Ranap.isEmpty()||Beban_Jasa_Menejemen_Radiologi_Ranap.isEmpty()||Utang_Jasa_Menejemen_Radiologi_Ranap.isEmpty()||
                    Suspen_Piutang_Obat_Ranap.isEmpty()||Obat_Ranap.isEmpty()||HPP_Obat_Rawat_Inap.isEmpty()||Persediaan_Obat_Rawat_Inap.isEmpty()||
                    Registrasi_Ranap.isEmpty()||Service_Ranap.isEmpty()||Tambahan_Ranap.isEmpty()||Potongan_Ranap.isEmpty()||Retur_Obat_Ranap.isEmpty()||
                    Resep_Pulang_Ranap.isEmpty()||Kamar_Inap.isEmpty()||Suspen_Piutang_Operasi_Ranap.isEmpty()||Operasi_Ranap.isEmpty()||
                    Beban_Jasa_Medik_Dokter_Operasi_Ranap.isEmpty()||Utang_Jasa_Medik_Dokter_Operasi_Ranap.isEmpty()||Beban_Jasa_Medik_Paramedis_Operasi_Ranap.isEmpty()||
                    Utang_Jasa_Medik_Paramedis_Operasi_Ranap.isEmpty()||HPP_Obat_Operasi_Ranap.isEmpty()||Persediaan_Obat_Kamar_Operasi_Ranap.isEmpty()||
                    Harian_Ranap.isEmpty()||Uang_Muka_Ranap.isEmpty()||Piutang_Pasien_Ranap.isEmpty()||Kerugian_Klaim_BPJS_RVP.isEmpty()||Lebih_Bayar_Klaim_BPJS_RVP.isEmpty()||
                    Piutang_BPJS_RVP.isEmpty()||Sisa_Uang_Muka_Ranap.isEmpty()||Kontra_Penerimaan_AsetInventaris.isEmpty()||Kontra_Hibah_Aset.isEmpty()||
                    Hibah_Non_Medis.isEmpty()||Kontra_Hibah_Non_Medis.isEmpty()||Bayar_JM_Dokter.isEmpty()||PPN_Masukan.isEmpty()||Stok_Keluar_Dapur.isEmpty()||
                    Kontra_Stok_Keluar_Dapur.isEmpty()||Pengadaan_Dapur.isEmpty()||PPN_Keluaran.isEmpty()||Diskon_Piutang.isEmpty()||Piutang_Tidak_Terbayar.isEmpty()||
