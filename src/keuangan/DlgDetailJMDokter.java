    ...
    private void laporan2() {
        try{
           ...
           try {
                ...
                ttluangrs=0;
                while(rs.next()){
                    htmlContent.append("<tr class='isi'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi'><td valign='middle' align='left' colspan='13'>").append(i).append(". ").append(rs.getString("nm_dokter")).append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFAFA' align='center' width='2%'>No.</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='10%'>Tanggal</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='5%'>No.RM</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='13%'>Nama Pasien</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='11%'>Ruang</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='8%'>Jenis Bayar</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='17%'>Nama Tindakan</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='6%'>Tarif</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='2%'>Jml</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='7%'>Biaya</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='7%'>Paket BHP/Obat</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='6%'>J.M.Dokter</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='6%'>J.S.Rmh Skt</td></tr>");
                    c=1;
                    //jmralan
                    if(chkRalan.isSelected()==true){
                        pspasienralan=koneksi.prepareStatement(
                                ...
                                try {
                                    ...
                                    while(rstindakan.next()){
                                        ...
                                        if(a==1){
                                            ...
                                            htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(rspasien.getString("tgl_registrasi")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("total_byrdr"))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("total"))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("bhp"))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("tarif_tindakandr"))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("material"))).append("</td></tr>");
                                        }                           
                                        a++;
                                    }
                                } catch (Exception e) {
                                ...
                                try {
                                    ...
                                    while(rstindakan.next()){
                                        ...
                                        try {
                                            ...
                                            ttlbhp=ttlbhp+rstindakan.getDouble("bhp")+detailbhp;
                                            if(a==1){
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(c).append("</td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (P.J. Lab)</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("total_byr")+biayaitem))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("total")+detailtotal))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("bhp")+detailbhp))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("tarif_tindakan_dokter")+detailjm))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("bagian_rs")+detailrs))).append("</td></tr>");
                                                c++;
                                            }else{
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (P.J. Lab)</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("total_byr")+biayaitem))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("total")+detailtotal))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("bhp")+detailbhp))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("tarif_tindakan_dokter")+detailjm))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("bagian_rs")+detailrs))).append("</td></tr>");
                                            }                           
                                ...
                                try {
                                    ...
                                    while(rstindakan.next()){
                                        ...
                                        try {
                                            ...
                                            ttlbhp=ttlbhp+rstindakan.getDouble("bhp")+detailbhp;
                                            if(a==1){
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(c).append("</td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (Perujuk Lab)</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("total_byr")+biayaitem))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("total")+detailtotal))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("bhp")+detailbhp))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("tarif_perujuk")+detailjm))).append("</td><td valign='middle' align='right'>0</td></tr>");
                                                c++;
                                            }else{
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (Perujuk Lab)</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("total_byr")+biayaitem))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("total")+detailtotal))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("bhp")+detailbhp))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("tarif_perujuk")+detailjm))).append("</td><td valign='middle' align='right'>0</td></tr>");
                                            }                           
                                        ...
                                        try {
                                            ...
                                            while(rstindakan.next()){
                                                ...
                                                if(a==1){
                                                    ...
                                                    htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(tanggal).append("</td><td valign='middle' align='left'>").append(norm).append("</td><td valign='middle' align='left'>").append(pasien).append("</td><td valign='middle' align='left'>").append(kamar).append("</td><td valign='middle' align='center'>").append(penjab).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("total_byrdr"))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("total"))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("bhp"))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("tarif_tindakandr"))).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(rstindakan.getDouble("material"))).append("</td></tr>");   
                                                }                           
                                                a++;
                                            }
                                        } catch (Exception e) {
                ...
                if(i>0){
                    htmlContent.append("<tr class='isi'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi'><td valign='middle' align='left' colspan='8' width='72%'>Total :</td><td valign='middle' align='center' width='2%'>").append(Valid.SetAngka(ttljml)).append("</td><td valign='middle' align='right' width='7%'>").append(Valid.SetAngka(ttlbiaya)).append("</td><td valign='middle' align='right' width='7%'>").append(Valid.SetAngka(ttlbhp)).append("</td><td valign='middle' align='right' width='6%'>").append(Valid.SetAngka(ttljm)).append("</td><td valign='middle' align='right' width='6%'>").append(Valid.SetAngka(ttluangrs)).append("</td></tr></table></td></tr>");  
                }
                LoadHTML.setText(
                    "<html>"+
                      "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
    ...
    private void laporan3() {
        try{
           ...
           try {
                                ...
                                try {
                                    ...
                                    while(rstindakan.next()){
                                        ...
                                        try {
                                            ...
                                            ttlbhp=ttlbhp+rstindakan.getDouble("bhp")+detailbhp;
                                            if(a==1){
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(c).append("</td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (P.J. Lab)</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("total_byr")+biayaitem))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("total")+detailtotal))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("bhp")+detailbhp))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("tarif_tindakan_dokter")+detailjm))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("bagian_rs")+detailrs))).append("</td></tr>");
                                                c++;
                                            }else{
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (P.J. Lab)</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("total_byr")+biayaitem))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("total")+detailtotal))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("bhp")+detailbhp))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("tarif_tindakan_dokter")+detailjm))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("bagian_rs")+detailrs))).append("</td></tr>");
                                            }                           
                                ...
                                try {
                                    ...
                                    while(rstindakan.next()){
                                        ...
                                        try {
                                            ...
                                            ttlbhp=ttlbhp+rstindakan.getDouble("bhp")+detailbhp;
                                            if(a==1){
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(c).append("</td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (Perujuk Lab)</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("total_byr")+biayaitem))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("total")+detailtotal))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("bhp")+detailbhp))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("tarif_perujuk")+detailjm))).append("</td><td valign='middle' align='right'>0</td></tr>");
                                                c++;
                                            }else{
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (Perujuk Lab)</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("total_byr")+biayaitem))).append("</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("total")+detailtotal))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("bhp")+detailbhp))).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("tarif_perujuk")+detailjm))).append("</td><td valign='middle' align='right'>0</td></tr>");
                                            }                           
                ...
                if(i>0){
                    htmlContent.append("<tr class='isi'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi'><td valign='middle' align='left' colspan='8' width='72%'>Total :</td><td valign='middle' align='center' width='2%'>").append(Math.round(ttljml)).append("</td><td valign='middle' align='right' width='7%'>").append(Math.round(ttlbiaya)).append("</td><td valign='middle' align='right' width='7%'>").append(Math.round(ttlbhp)).append("</td><td valign='middle' align='right' width='6%'>").append(Math.round(ttljm)).append("</td><td valign='middle' align='right' width='6%'>").append(Math.round(ttluangrs)).append("</td></tr></table></td></tr>");  
                }
                LoadHTML2.setText(
                    "<html>"+
                      "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
    ...
    private void jasamedis() {
        try{
           ...
           try {
                ...
                ttluangrs=0;
                while(rs.next()){
                    htmlContent.append("<tr class='isi2'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi2'><td valign='middle' align='left' width='15%'>Nama</td><td valign='middle' align='left' width='85%'>: ").append(rs.getString("nm_dokter")).append("</td></tr><tr class='isi2'><td valign='middle' align='left' width='15%'>Bulan</td><td valign='middle' align='left' width='85%'>: ").append(Tgl1.getSelectedItem().toString().substring(3,10)).append("</td></tr></table></td></tr><tr class='isi'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi'><td valign='middle' bgcolor='#FFFAFA' align='center' width='3%'>No.</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='10%'>Tanggal</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='5%'>No.RM</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='18%'>Nama Pasien</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='14%'>Ruang</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='8%'>Jenis Bayar</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='30%'>Nama Tindakan</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='2%'>Jml</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='10%'>J.M.Dokter</td></tr>");
                    c=1;
                    //jmralan
                    if(chkRalan.isSelected()==true){
                        pspasienralan=koneksi.prepareStatement(
                                ...
                                try {
                                    ...
                                    while(rstindakan.next()){
                                        ...
                                        try {
                                            ...
                                            ttlbhp=ttlbhp+rstindakan.getDouble("bhp")+detailbhp;
                                            if(a==1){
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(c).append("</td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (P.J. Lab)</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("tarif_tindakan_dokter")+detailjm))).append("</td></tr>");
                                                c++;
                                            }else{
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (P.J. Lab)</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("tarif_tindakan_dokter")+detailjm))).append("</td></tr>");
                                            }                           
                                ...
                                try {
                                    ...
                                    while(rstindakan.next()){
                                        ...
                                        try {
                                            ...
                                            ttlbhp=ttlbhp+rstindakan.getDouble("bhp")+detailbhp;
                                            if(a==1){
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(c).append("</td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (Perujuk Lab)</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("tarif_perujuk")+detailjm))).append("</td></tr>");
                                                c++;
                                            }else{
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (Perujuk Lab)</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka((rstindakan.getDouble("tarif_perujuk")+detailjm))).append("</td></tr>");
                                            }                           
                ...
                if(i>0){
                    htmlContent.append("<tr class='isi'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi'><td valign='middle' align='left' colspan='11' width='88%'>Total :</td><td valign='middle' align='center' width='2%'>").append(Valid.SetAngka(ttljml)).append("</td><td valign='middle' align='right' width='10%'>").append(Valid.SetAngka(ttluangrs)).append("</td></tr></table></td></tr><tr class='isi2'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>Yang Menerima</td><td valign='middle' border='none' align='center' colspan='7' width='50%'>Pengelola</td></tr><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>&nbsp;</td><td valign='middle' align='center' colspan='7' width='50%'>&nbsp;</td></tr><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>&nbsp;</td><td valign='middle' align='center' colspan='7' width='50%'>&nbsp;</td></tr><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>&nbsp;</td><td valign='middle' align='center' colspan='7' width='50%'>&nbsp;</td></tr><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>").append(nmdokter.getText()).append("</td><td valign='middle' align='center' colspan='7' width='50%'>______________________</td></tr></table></td></tr>");  
                }
           } catch (Exception e) {
               System.out.println("Notifikasi ps : "+e);
           } finally{
    ...
    private void jasamedis2() {
        try{
           ...
           try {
                                ...
                                try {
                                    ...
                                    while(rstindakan.next()){
                                        ...
                                        try {
                                            ...
                                            ttlbhp=ttlbhp+rstindakan.getDouble("bhp")+detailbhp;
                                            if(a==1){
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(c).append("</td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (P.J. Lab)</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("tarif_tindakan_dokter")+detailjm))).append("</td></tr>");
                                                c++;
                                            }else{
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (P.J. Lab)</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("tarif_tindakan_dokter")+detailjm))).append("</td></tr>");
                                            }                           
                                ...
                                try {
                                    ...
                                    while(rstindakan.next()){
                                        ...
                                        try {
                                            ...
                                            ttlbhp=ttlbhp+rstindakan.getDouble("bhp")+detailbhp;
                                            if(a==1){
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>").append(c).append("</td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (Perujuk Lab)</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("tarif_perujuk")+detailjm))).append("</td></tr>");
                                                c++;
                                            }else{
                                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'></td><td valign='middle' align='left'>").append(rspasien.getString("tgl_periksa")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("no_rkm_medis")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_pasien")).append("</td><td valign='middle' align='left'>").append(rspasien.getString("nm_poli")).append("</td><td valign='middle' align='center'>").append(rspasien.getString("png_jawab")).append("</td><td valign='middle' align='left'>").append(rstindakan.getString("nm_perawatan")).append(" (Perujuk Lab)</td><td valign='middle' align='center'>").append(rstindakan.getDouble("jml")).append("</td><td valign='middle' align='right'>").append(Math.round((rstindakan.getDouble("tarif_perujuk")+detailjm))).append("</td></tr>");
                                            }                           
                ...
                if(i>0){
                    htmlContent.append("<tr class='isi'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi'><td valign='middle' align='left' colspan='11' width='88%'>Total :</td><td valign='middle' align='center' width='2%'>").append(Math.round(ttljml)).append("</td><td valign='middle' align='right' width='10%'>").append(Math.round(ttluangrs)).append("</td></tr></table></td></tr><tr class='isi2'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>Yang Menerima</td><td valign='middle' border='none' align='center' colspan='7' width='50%'>Pengelola</td></tr><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>&nbsp;</td><td valign='middle' align='center' colspan='7' width='50%'>&nbsp;</td></tr><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>&nbsp;</td><td valign='middle' align='center' colspan='7' width='50%'>&nbsp;</td></tr><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>&nbsp;</td><td valign='middle' align='center' colspan='7' width='50%'>&nbsp;</td></tr><tr class='isi2'><td valign='middle' align='center' colspan='6' width='50%'>").append(nmdokter.getText()).append("</td><td valign='middle' align='center' colspan='7' width='50%'>______________________</td></tr></table></td></tr>");  
                }
           } catch (Exception e) {
               System.out.println("Notifikasi ps : "+e);
           } finally{
