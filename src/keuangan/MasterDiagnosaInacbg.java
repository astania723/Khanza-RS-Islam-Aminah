...
public class MasterDiagnosaInacbg extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().isEmpty()){
            ...
            if(Sequel.menyimpantf("master_kmkb","'"+TKd.getText()+"','"+KdInacbg.getText()+"','"+TarifInacbg.getText()+"','"+ICD10.getText()+"','"+Deskripsi.getText()+"','"+Kelas.getSelectedItem().toString()+"'","Kode")==true){
                tabMode.addRow(new String[]{TKd.getText(),KdInacbg.getText(),TarifInacbg.getText(),ICD10.getText(),Deskripsi.getText(),Kelas.getSelectedItem().toString()});
                emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().isEmpty()){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("master_kmkb","kd_kmkb=?","kd_kmkb=?,inacbg=?,tarif_ina=?,icd10=?,deskripsi=?,kelas=?",7,new String[]{
                    TKd.getText(),KdInacbg.getText(),TarifInacbg.getText(),ICD10.getText(),Deskripsi.getText(),Kelas.getSelectedItem().toString(),tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),0).toString()
                })==true){
                    tbSpesialis.setValueAt(TKd.getText(),tbSpesialis.getSelectedRow(),0);
                    tbSpesialis.setValueAt(KdInacbg.getText(),tbSpesialis.getSelectedRow(),1);
                    tbSpesialis.setValueAt(TarifInacbg.getText(),tbSpesialis.getSelectedRow(),2);
                    tbSpesialis.setValueAt(ICD10.getText(),tbSpesialis.getSelectedRow(),3);
                    tbSpesialis.setValueAt(Deskripsi.getText(),tbSpesialis.getSelectedRow(),4);
                    tbSpesialis.setValueAt(Kelas.getSelectedItem().toString(),tbSpesialis.getSelectedRow(),5);
                    emptTeks();
                }
            }
        }
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_kmkb where master_kmkb.icd10 like ? or master_kmkb.inacbg like ? order by master_kmkb.kd_kmkb");
            try {
