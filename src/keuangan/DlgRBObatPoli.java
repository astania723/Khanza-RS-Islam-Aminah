    ...
    */
    ...
    private void prosesCari() {             
        try{   
           ...
           try {
                if(kdpoli.getText().isEmpty()){}else{
                ...
                while(rspoli.next()){
                    ...
                    try {
                        ...
                        a=1;
                        while(rsdokter.next()){ 
                            if(nmjns.getText().isEmpty()&&nmkategori.getText().isEmpty()&&nmgolongan.getText().isEmpty()&&nmasal.getText().isEmpty()&&nmpenjab.getText().isEmpty()){
