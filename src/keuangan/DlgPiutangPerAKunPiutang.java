    ...
    */
    ...
    public void tampil(){
        ...
        try{        
            ...
            htmlContent.append("<tr class='isi'><td valign='middle' align='center'></td><td valign='middle' align='right'>Total :</td><td valign='middle' align='center'></td><td valign='middle' align='center'></td><td valign='middle' align='right'>").append(Valid.SetAngka(uangmuka)).append("</td><td valign='middle' align='right'>").append(Valid.SetAngka(piutang)).append("</td>");
            for(i=0;i<kolom;i++){
