                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                                ...
                                while(rs.next()){
                                    htmlContent.append("<tr class='isi'><td valign='top'>").append(rs.getString("no_pernyataan")).append("</td><td valign='top'>").append(rs.getString("no_rawat")).append("</td><td valign='top'>").append(rs.getString("no_rkm_medis")).append("</td><td valign='top'>").append(rs.getString("nm_pasien")).append("</td><td valign='top'>").append(rs.getString("tgl_lahir")).append("</td><td valign='top'>").append(rs.getString("jk")).append("</td><td valign='top'>").append(rs.getString("tanggal")).append("</td><td valign='top'>").append(rs.getString("diagnosa")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("diagnosa_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("tindakan")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("tindakan_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("indikasi_tindakan")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("indikasi_tindakan_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("tata_cara")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("tata_cara_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("tujuan")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("tujuan_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("risiko")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("risiko_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("komplikasi")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("komplikasi_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("prognosis")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("prognosis_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("alternatif_dan_risikonya")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("alternatif_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("lain_lain")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("lain_lain_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("biaya")).append("</td><td valign='top' align='center'><input type=checkbox ").append(rs.getString("biaya_konfirmasi").replaceAll("true","checked").replaceAll("false","")).append("></td><td valign='top'>").append(rs.getString("kd_dokter")).append("</td><td valign='top'>").append(rs.getString("nm_dokter")).append("</td><td valign='top'>").append(rs.getString("nip")).append("</td><td valign='top'>").append(rs.getString("nama")).append("</td><td valign='top'>").append(rs.getString("penerima_informasi")).append("</td><td valign='top'>").append(rs.getString("alasan_diwakilkan_penerima_informasi")).append("</td><td valign='top'>").append(rs.getString("jk_penerima_informasi")).append("</td><td valign='top'>").append(rs.getString("tanggal_lahir_penerima_informasi")).append("</td><td valign='top'>").append(rs.getString("umur_penerima_informasi")).append("</td><td valign='top'>").append(rs.getString("alamat_penerima_informasi")).append("</td><td valign='top'>").append(rs.getString("no_hp")).append("</td><td valign='top'>").append(rs.getString("hubungan_penerima_informasi")).append("</td><td valign='top'>").append(rs.getString("pernyataan")).append("</td><td valign='top'>").append(rs.getString("saksi_keluarga")).append("</td></tr>");
                                }
                        ...
                        case "Laporan 3 (CSV)":
                                ...
                                while(rs.next()){
                                    htmlContent.append("\"").append(rs.getString("no_pernyataan")).append("\";\"").append(rs.getString("no_rawat")).append("\";\" ").append(rs.getString("no_rkm_medis")).append("\";\"").append(rs.getString("nm_pasien")).append("\";\"").append(rs.getString("tgl_lahir")).append("\";\"").append(rs.getString("jk")).append("\";\"").append(rs.getString("tanggal")).append("\";\"").append(rs.getString("diagnosa")).append("\";\"").append(rs.getString("diagnosa_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("tindakan")).append("\";\"").append(rs.getString("tindakan_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("indikasi_tindakan")).append("\";\"").append(rs.getString("indikasi_tindakan_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("tata_cara")).append("\";\"").append(rs.getString("tata_cara_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("tujuan")).append("\";\"").append(rs.getString("tujuan_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("risiko")).append("\";\"").append(rs.getString("risiko_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("komplikasi")).append("\";\"").append(rs.getString("komplikasi_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("prognosis")).append("\";\"").append(rs.getString("prognosis_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("alternatif_dan_risikonya")).append("\";\"").append(rs.getString("alternatif_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("lain_lain")).append("\";\"").append(rs.getString("lain_lain_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("biaya")).append("\";\"").append(rs.getString("biaya_konfirmasi").replaceAll("true","Ya").replaceAll("false","Tidak")).append("\";\"").append(rs.getString("kd_dokter")).append("\";\"").append(rs.getString("nm_dokter")).append("\";\"").append(rs.getString("nip")).append("\";\"").append(rs.getString("nama")).append("\";\"").append(rs.getString("penerima_informasi")).append("\";\"").append(rs.getString("alasan_diwakilkan_penerima_informasi")).append("\";\"").append(rs.getString("jk_penerima_informasi")).append("\";\"").append(rs.getString("tanggal_lahir_penerima_informasi")).append("\";\"").append(rs.getString("umur_penerima_informasi")).append("\";\"").append(rs.getString("alamat_penerima_informasi")).append("\";\"").append(rs.getString("no_hp")).append("\";\"").append(rs.getString("hubungan_penerima_informasi")).append("\";\"").append(rs.getString("pernyataan")).append("\";\"").append(rs.getString("saksi_keluarga")).append("\"\n");
                                }
