...
*/
    ...
    private void BtnSimpan4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan4ActionPerformed
        if(kdoperator2.getText().trim().isEmpty()||nmoperator2.getText().trim().isEmpty()){
            kdoperator2.setText("-");
            nmoperator2.setText("-");
        }

        if(kdoperator3.getText().trim().isEmpty()||nmoperator3.getText().trim().isEmpty()){
            kdoperator3.setText("-");
            nmoperator3.setText("-");
        }

        if(kdanestesi.getText().trim().isEmpty()||nmanestesi.getText().trim().isEmpty()){
            kdanestesi.setText("-");
            nmanestesi.setText("-");
        }

        if(kddranak.getText().trim().isEmpty()||nmdranak.getText().trim().isEmpty()){
            kddranak.setText("-");
            nmdranak.setText("-");
        }

        if(kdbidan.getText().trim().isEmpty()||nmbidan.getText().trim().isEmpty()){
            kdbidan.setText("-");
            nmbidan.setText("-");
        }

        if(kdbidan2.getText().trim().isEmpty()||nmbidan2.getText().trim().isEmpty()){
            kdbidan2.setText("-");
            nmbidan2.setText("-");
        }

        if(kdbidan3.getText().trim().isEmpty()||nmbidan3.getText().trim().isEmpty()){
            kdbidan3.setText("-");
            nmbidan3.setText("-");
        }

        if(kdonloop1.getText().trim().isEmpty()||nmonloop1.getText().trim().isEmpty()){
            kdonloop1.setText("-");
            nmonloop1.setText("-");
        }

        if(kdonloop2.getText().trim().isEmpty()||nmonloop2.getText().trim().isEmpty()){
            kdonloop2.setText("-");
            nmonloop2.setText("-");
        }

        if(kdonloop3.getText().trim().isEmpty()||nmonloop3.getText().trim().isEmpty()){
            kdonloop3.setText("-");
            nmonloop3.setText("-");
        }
        
        if(kdonloop4.getText().trim().isEmpty()||nmonloop4.getText().trim().isEmpty()){
            kdonloop4.setText("-");
            nmonloop4.setText("-");
        }
        
        if(kdonloop5.getText().trim().isEmpty()||nmonloop5.getText().trim().isEmpty()){
            kdonloop5.setText("-");
            nmonloop5.setText("-");
        }

        if(kdasistoperator1.getText().trim().isEmpty()||nmasistoperator1.getText().trim().isEmpty()){
            kdasistoperator1.setText("-");
            nmasistoperator1.setText("-");
        }

        if(kdasistoperator2.getText().trim().isEmpty()||nmasistoperator2.getText().trim().isEmpty()){
            kdasistoperator2.setText("-");
            nmasistoperator2.setText("-");
        }
        
        if(kdasistoperator3.getText().trim().isEmpty()||nmasistoperator3.getText().trim().isEmpty()){
            kdasistoperator3.setText("-");
            nmasistoperator3.setText("-");
        }

        if(kdInstrumen.getText().trim().isEmpty()||nminstrumen.getText().trim().isEmpty()){
            kdInstrumen.setText("-");
            nminstrumen.setText("-");
        }

        if(kdasistanestesi.getText().trim().isEmpty()||nmasistanestesi.getText().trim().isEmpty()){
            kdasistanestesi.setText("-");
            nmasistanestesi.setText("-");
        }
        
        if(kdasistanestesi2.getText().trim().isEmpty()||nmasistanestesi2.getText().trim().isEmpty()){
            kdasistanestesi2.setText("-");
            nmasistanestesi2.setText("-");
        }

        if(kdprwresust.getText().trim().isEmpty()||nmprwresust.getText().trim().isEmpty()){
            kdprwresust.setText("-");
            nmprwresust.setText("-");
        }

        if(kdprwluar.getText().trim().isEmpty()||nmprwluar.getText().trim().isEmpty()){
            kdprwluar.setText("-");
            nmprwluar.setText("-");
        }
        
        if(kdpjanak.getText().trim().isEmpty()||nmpjanak.getText().trim().isEmpty()){
            kdpjanak.setText("-");
            nmpjanak.setText("-");
        }
        
        if(kddrumum.getText().trim().isEmpty()||nmdrumum.getText().trim().isEmpty()){
            kddrumum.setText("-");
            nmdrumum.setText("-");
        }

        if(kdoperator1.getText().trim().isEmpty()||nmoperator1.getText().trim().isEmpty()){
            Valid.textKosong(kdoperator1,"Operator 1");
        }else if(kdoperator2.getText().trim().isEmpty()||nmoperator2.getText().trim().isEmpty()){
            Valid.textKosong(kdoperator2,"Operator 2");
        }else if(kdoperator3.getText().trim().isEmpty()||nmoperator3.getText().trim().isEmpty()){
            Valid.textKosong(kdoperator3,"Operator 3");
        }else if(kdanestesi.getText().trim().isEmpty()||nmanestesi.getText().trim().isEmpty()){
            Valid.textKosong(kdanestesi,"dr Anestesi");
        }else if(kddranak.getText().trim().isEmpty()||nmdranak.getText().trim().isEmpty()){
            Valid.textKosong(kddranak,"dr Anak");
        }else if(kdbidan.getText().trim().isEmpty()||nmbidan.getText().trim().isEmpty()){
            Valid.textKosong(kdbidan,"Bidan 1");
        }else if(kdbidan2.getText().trim().isEmpty()||nmbidan2.getText().trim().isEmpty()){
            Valid.textKosong(kdbidan,"Bidan 2");
        }else if(kdbidan3.getText().trim().isEmpty()||nmbidan3.getText().trim().isEmpty()){
            Valid.textKosong(kdbidan,"Bidan 3");
        }else if(kdonloop1.getText().trim().isEmpty()||nmonloop1.getText().trim().isEmpty()){
            Valid.textKosong(kdonloop1,"Onloop 1");
        }else if(kdonloop2.getText().trim().isEmpty()||nmonloop2.getText().trim().isEmpty()){
            Valid.textKosong(kdonloop2,"Onloop 2");
        }else if(kdonloop3.getText().trim().isEmpty()||nmonloop3.getText().trim().isEmpty()){
            Valid.textKosong(kdonloop3,"Onloop 3");
        }else if(kdonloop4.getText().trim().isEmpty()||nmonloop4.getText().trim().isEmpty()){
            Valid.textKosong(kdonloop4,"Onloop 4");
        }else if(kdonloop5.getText().trim().isEmpty()||nmonloop5.getText().trim().isEmpty()){
            Valid.textKosong(kdonloop5,"Onloop 5");
        }else if(kdasistoperator1.getText().trim().isEmpty()||nmasistoperator1.getText().trim().isEmpty()){
            Valid.textKosong(kdasistoperator1,"Asisten Operator 1");
        }else if(kdasistoperator2.getText().trim().isEmpty()||nmasistoperator2.getText().trim().isEmpty()){
            Valid.textKosong(kdasistoperator2,"Asisten Operator 2");
        }else if(kdasistoperator3.getText().trim().isEmpty()||nmasistoperator3.getText().trim().isEmpty()){
            Valid.textKosong(kdasistoperator3,"Asisten Operator 3");
        }else if(kdInstrumen.getText().trim().isEmpty()||nminstrumen.getText().trim().isEmpty()){
            Valid.textKosong(kdInstrumen,"Instrumen");
        }else if(kdasistanestesi.getText().trim().isEmpty()||nmasistanestesi.getText().trim().isEmpty()){
            Valid.textKosong(kdasistanestesi,"Asisten Anastesi 1");
        }else if(kdasistanestesi2.getText().trim().isEmpty()||nmasistanestesi2.getText().trim().isEmpty()){
            Valid.textKosong(kdasistanestesi2,"Asisten Anastesi 2");
        }else if(kdprwresust.getText().trim().isEmpty()||nmprwresust.getText().trim().isEmpty()){
            Valid.textKosong(kdprwresust,"Perawat Resusitas");
        }else if(kdprwluar.getText().trim().isEmpty()||nmprwluar.getText().trim().isEmpty()){
            Valid.textKosong(kdprwluar,"Perawat Luar");
        }else if(kdpjanak.getText().trim().isEmpty()||nmpjanak.getText().trim().isEmpty()){
            Valid.textKosong(kdpjanak,"dr Pj Anak");
        }else if(kddrumum.getText().trim().isEmpty()||nmdrumum.getText().trim().isEmpty()){
    ...
    private void MnLaporanOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanOperasiActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().isEmpty()){
                Map<String, Object> param = new HashMap<>();    
                param.put("namars",akses.getnamars());
                param.put("alamatrs",akses.getalamatrs());
                param.put("kotars",akses.getkabupatenrs());
    ...
    private void tampil() {
        ...
        if(TCari.getText().trim().isEmpty()&&NoRawat.getText().trim().isEmpty()){
            ...
            sql="select operasi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,operasi.jenis_anasthesi,"+
                "operasi.tgl_operasi from operasi inner join reg_periksa on operasi.no_rawat=reg_periksa.no_rawat "+
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                " where "+norawat+" and operasi.no_rawat like '%"+TCari.getText()+"%' or "+
                norawat+" and reg_periksa.no_rkm_medis like '%"+TCari.getText()+"%' or "+
                norawat+" and pasien.nm_pasien like '%"+TCari.getText()+"%' or "+
                norawat+" and operasi.tgl_operasi like '%"+TCari.getText()+"%' or "+
                norawat+" and operasi.jenis_anasthesi like '%"+TCari.getText()+"%'  "+                   
