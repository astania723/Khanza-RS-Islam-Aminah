                            ...
                            try {
                                ...
                                while(rs3.next()){
                                    ...
                                    try {
                                        ...
                                        rs5.beforeFirst();
                                        while(rs5.next()){
                                            htmlContent.append("<tr class='isi'><td valign='top'>").append(rs5.getString("Pemeriksaan")).append("</td><td valign='top' align='center'>").append(rs5.getString("nilai")).append("</td><td valign='top' align='center'>").append(rs5.getString("nilai_rujukan")).append("</td><td valign='top'>").append(rs5.getString("keterangan")).append("</td></tr>");
                                            jmlsubpemeriksaan++;
                                        }
                                    } catch (Exception e) {
                                        System.out.println("Notif : "+e);
