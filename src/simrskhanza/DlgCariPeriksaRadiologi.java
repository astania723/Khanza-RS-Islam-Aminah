                ...
                if((!Kd2.getText().isEmpty())&&(!Petugas.getText().isEmpty())){
                     try {
                        ...
                        try {
                            ...
                            while(rs.next()){
                                htmlContent.append("<tr><td border='0' align='center'><a href='http://").append(koneksiDB.HOSTHYBRIDWEB()).append(":").append(koneksiDB.PORTWEB()).append("/").append(koneksiDB.HYBRIDWEB()).append("/radiologi/").append(rs.getString("lokasi_gambar")).append("'><img src='http://").append(koneksiDB.HOSTHYBRIDWEB()).append(":").append(koneksiDB.PORTWEB()).append("/").append(koneksiDB.HYBRIDWEB()).append("/radiologi/").append(rs.getString("lokasi_gambar")).append("' alt='photo' width='").append(internalFrame1.getWidth()-370).append("' height='").append(internalFrame1.getWidth()-370).append("'/></a></td></tr>");
                            }
                            LoadHTML.setText(
                                "<html>"+
