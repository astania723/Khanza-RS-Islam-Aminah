...
public class DlgPermintaanRanap extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(KdBangsal.getText().trim().isEmpty()||KdKamar.getText().trim().isEmpty()||NmBangsal.getText().trim().isEmpty()){
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(R1.isSelected()==true){
                sql="select permintaan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    ...
                    (TCari.getText().isEmpty()?"":"and (permintaan_ranap.no_rawat like '%"+TCari.getText().trim()+"%' or reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or pasien.nm_pasien like '%"+TCari.getText().trim()+"%' "+
