                ...
                if(tbTarifPK.getValueAt(i2,0).toString().equals("true")){
                    ...
                    try {
                        ...
                        while(rstampil.next()){
                            ...
                            psotomatis=koneksi.prepareStatement("select template_perawatan from set_otomatis_tindakan_lab where template_perawatan = ? and kd_jenis_prw = ?");
                            try{
                                psotomatis.setString(1, rstampil.getString("Pemeriksaan"));
                                psotomatis.setString(2, tbTarifPK.getValueAt(i2,1).toString());
                                rsotomatis=psotomatis.executeQuery();
                                if(rsotomatis.next()){
                                tabMode.addRow(new Object[]{
