        ...
        if(nmdokter.getText().trim().isEmpty()){
            ...
            if(Sequel.menyimpantf("jadwal","'"+kddokter.getText()+"','"+cmbHari.getSelectedItem()+"','"+
                ...
                tabMode.addRow(new Object[]{
                    ...
                    cmbJam2.getSelectedItem()+":"+cmbMnt2.getSelectedItem()+":"+cmbDtk2.getSelectedItem(),TPoli.getText(),Double.valueOf(Kuota.getText())
                });
                emptTeks();
        ...
        if(nmdokter.getText().trim().isEmpty()){
            ...
            if(tbJadwal.getSelectedRow()!= -1){
                if(Sequel.queryutf("update jadwal set jam_mulai='"+cmbJam1.getSelectedItem()+":"+cmbMnt1.getSelectedItem()+":"+cmbDtk1.getSelectedItem()+"',"+
                    ...
                    tbJadwal.setValueAt(Double.valueOf(Kuota.getText()),tbJadwal.getSelectedRow(),7);
                    emptTeks();
                }
            }  
        }
