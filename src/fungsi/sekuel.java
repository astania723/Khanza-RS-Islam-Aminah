...
public class sekuel {
    ...
    public boolean cekTanggalRegistrasi(String tanggalregistrasi, String tanggalinputdata) {
        try {
            psbolehmundur = connect.prepareStatement("select set_validasi_boleh_mundur.boleh_mundur from set_validasi_boleh_mundur");
            try {
        ...
        if (BOLEHMUNDUR.equals("Yes")) {
            ...
            try {
                ...
                if (bedawaktu < 0) {
                    bool = false;
                    JOptionPane.showMessageDialog(null, "Maaf, jam input data / perubahan data minimal di jam " + tanggalregistrasi + " ! atau hubungi pendaftaran untuk update jam registrasi");
                } else {
                    bool = true;
                }
            } catch (Exception ex) {
